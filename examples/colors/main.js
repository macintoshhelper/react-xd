...
/***/ "../../dist/bundle.esm.js":
/*!************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/dist/bundle.esm.js ***!
  \************************************************************************************/
/*! exports provided: Artboard, Document, Text, View, render */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Artboard", function() { return Artboard$1; });
...
/* harmony import */ var scenegraph__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! scenegraph */ "scenegraph");
/* harmony import */ var scenegraph__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(scenegraph__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var commands__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! commands */ "commands");
/* harmony import */ var commands__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(commands__WEBPACK_IMPORTED_MODULE_2__);
var commonjsGlobal=typeof globalThis!=='undefined'?globalThis:typeof window!=='undefined'?window:typeof global!=='undefined'?global:typeof self!=='undefined'?self:{};function unwrapExports(x){return x&&x.__esModule&&Object.prototype.hasOwnProperty.call(x,'default')?x['default']:x;}function createCommonjsModule(fn,module){return module={exports:{}},fn(module,module.exports),module.exports;}/*
object-assign
(c) Sindre Sorhus
@license MIT
...
var firstCallbackNode=null;var currentDidTimeout=false;// Pausing the scheduler is useful for debugging.
var isSchedulerPaused=false;var currentPriorityLevel=NormalPriority;var currentEventStartTime=-1;var currentExpirationTime=-1;// This is set when a callback is being executed, to prevent re-entrancy.
var isExecutingCallback=false;var isHostCallbackScheduled=false;var hasNativePerformanceNow=typeof performance==='object'&&typeof performance.now==='function';function ensureHostCallbackIsScheduled(){if(isExecutingCallback){// Don't schedule work yet; wait until the next time we yield.
return;}// Schedule the host callback using the earliest expiration in the list.
var expirationTime=firstCallbackNode.expirationTime;if(!isHostCallbackScheduled){isHostCallbackScheduled=true;}else{// Cancel the existing host callback.
cancelHostCallback();}requestHostCallback(flushWork,expirationTime);}function flushFirstCallback(){var flushedNode=firstCallbackNode;// Remove the node from the list before calling the callback. That way the
// list is in a consistent state even if the callback throws.
var next=firstCallbackNode.next;if(firstCallbackNode===next){// This is the last callback in the list.
firstCallbackNode=null;next=null;}else{var lastCallbackNode=firstCallbackNode.previous;firstCallbackNode=lastCallbackNode.next=next;next.previous=lastCallbackNode;}flushedNode.next=flushedNode.previous=null;// Now it's safe to call the callback.
...
if(typeof continuationCallback==='function'){var continuationNode={callback:continuationCallback,priorityLevel:priorityLevel,expirationTime:expirationTime,next:null,previous:null};// Insert the new callback into the list, sorted by its expiration. This is
// almost the same as the code in `scheduleCallback`, except the callback
// is inserted into the list *before* callbacks of equal expiration instead
// of after.
if(firstCallbackNode===null){// This is the first callback in the list.
firstCallbackNode=continuationNode.next=continuationNode.previous=continuationNode;}else{var nextAfterContinuation=null;var node=firstCallbackNode;do{if(node.expirationTime>=expirationTime){// This callback expires at or after the continuation. We will insert
// the continuation *before* this callback.
nextAfterContinuation=node;break;}node=node.next;}while(node!==firstCallbackNode);if(nextAfterContinuation===null){// No equal or lower priority callback was found, which means the new
// callback is the lowest priority callback in the list.
nextAfterContinuation=firstCallbackNode;}else if(nextAfterContinuation===firstCallbackNode){// The new callback is the highest priority callback in the list.
firstCallbackNode=continuationNode;ensureHostCallbackIsScheduled();}var previous=nextAfterContinuation.previous;previous.next=nextAfterContinuation.previous=continuationNode;continuationNode.next=nextAfterContinuation;continuationNode.previous=previous;}}}function flushImmediateWork(){if(// Confirm we've exited the outer most event handler
currentEventStartTime===-1&&firstCallbackNode!==null&&firstCallbackNode.priorityLevel===ImmediatePriority){isExecutingCallback=true;try{do{flushFirstCallback();}while(// Keep flushing until there are no more immediate callbacks
firstCallbackNode!==null&&firstCallbackNode.priorityLevel===ImmediatePriority);}finally{isExecutingCallback=false;if(firstCallbackNode!==null){// There's still work remaining. Request another callback.
ensureHostCallbackIsScheduled();}else{isHostCallbackScheduled=false;}}}}function flushWork(didTimeout){isExecutingCallback=true;var previousDidTimeout=currentDidTimeout;currentDidTimeout=didTimeout;try{if(didTimeout){// Flush all the expired callbacks without yielding.
while(firstCallbackNode!==null&&!(enableSchedulerDebugging&&isSchedulerPaused)){// TODO Wrap in feature flag
...
if(firstCallbackNode!==null){do{if(enableSchedulerDebugging&&isSchedulerPaused){break;}flushFirstCallback();}while(firstCallbackNode!==null&&!shouldYieldToHost());}}}finally{isExecutingCallback=false;currentDidTimeout=previousDidTimeout;if(firstCallbackNode!==null){// There's still work remaining. Request another callback.
ensureHostCallbackIsScheduled();}else{isHostCallbackScheduled=false;}// Before exiting, flush all the immediate work that was scheduled.
flushImmediateWork();}}function unstable_runWithPriority(priorityLevel,eventHandler){switch(priorityLevel){case ImmediatePriority:case UserBlockingPriority:case NormalPriority:case LowPriority:case IdlePriority:break;default:priorityLevel=NormalPriority;}var previousPriorityLevel=currentPriorityLevel;var previousEventStartTime=currentEventStartTime;currentPriorityLevel=priorityLevel;currentEventStartTime=exports.unstable_now();try{return eventHandler();}finally{currentPriorityLevel=previousPriorityLevel;currentEventStartTime=previousEventStartTime;// Before exiting, flush all the immediate work that was scheduled.
flushImmediateWork();}}function unstable_next(eventHandler){var priorityLevel=void 0;switch(currentPriorityLevel){case ImmediatePriority:case UserBlockingPriority:case NormalPriority:// Shift down to normal priority
priorityLevel=NormalPriority;break;default:// Anything lower than normal priority should remain at the current level.
priorityLevel=currentPriorityLevel;break;}var previousPriorityLevel=currentPriorityLevel;var previousEventStartTime=currentEventStartTime;currentPriorityLevel=priorityLevel;currentEventStartTime=exports.unstable_now();try{return eventHandler();}finally{currentPriorityLevel=previousPriorityLevel;currentEventStartTime=previousEventStartTime;// Before exiting, flush all the immediate work that was scheduled.
flushImmediateWork();}}function unstable_wrapCallback(callback){var parentPriorityLevel=currentPriorityLevel;return function(){// This is a fork of runWithPriority, inlined for performance.
var previousPriorityLevel=currentPriorityLevel;var previousEventStartTime=currentEventStartTime;currentPriorityLevel=parentPriorityLevel;currentEventStartTime=exports.unstable_now();try{return callback.apply(this,arguments);}finally{currentPriorityLevel=previousPriorityLevel;currentEventStartTime=previousEventStartTime;flushImmediateWork();}};}function unstable_scheduleCallback(callback,deprecated_options){var startTime=currentEventStartTime!==-1?currentEventStartTime:exports.unstable_now();var expirationTime;if(typeof deprecated_options==='object'&&deprecated_options!==null&&typeof deprecated_options.timeout==='number'){// FIXME: Remove this branch once we lift expiration times out of React.
expirationTime=startTime+deprecated_options.timeout;}else{switch(currentPriorityLevel){case ImmediatePriority:expirationTime=startTime+IMMEDIATE_PRIORITY_TIMEOUT;break;case UserBlockingPriority:expirationTime=startTime+USER_BLOCKING_PRIORITY;break;case IdlePriority:expirationTime=startTime+IDLE_PRIORITY;break;case LowPriority:expirationTime=startTime+LOW_PRIORITY_TIMEOUT;break;case NormalPriority:default:expirationTime=startTime+NORMAL_PRIORITY_TIMEOUT;}}var newNode={callback:callback,priorityLevel:currentPriorityLevel,expirationTime:expirationTime,next:null,previous:null};// Insert the new callback into the list, ordered first by expiration, then
// by insertion. So the new callback is inserted any other callback with
// equal expiration.
if(firstCallbackNode===null){// This is the first callback in the list.
firstCallbackNode=newNode.next=newNode.previous=newNode;ensureHostCallbackIsScheduled();}else{var next=null;var node=firstCallbackNode;do{if(node.expirationTime>expirationTime){// The new callback expires before this one.
next=node;break;}node=node.next;}while(node!==firstCallbackNode);if(next===null){// No callback with a later expiration was found, which means the new
// callback has the latest expiration in the list.
next=firstCallbackNode;}else if(next===firstCallbackNode){// The new callback has the earliest expiration in the entire list.
firstCallbackNode=newNode;ensureHostCallbackIsScheduled();}var previous=next.previous;previous.next=next.previous=newNode;newNode.next=next;newNode.previous=previous;}return newNode;}function unstable_pauseExecution(){isSchedulerPaused=true;}function unstable_continueExecution(){isSchedulerPaused=false;if(firstCallbackNode!==null){ensureHostCallbackIsScheduled();}}function unstable_getFirstCallbackNode(){return firstCallbackNode;}function unstable_cancelCallback(callbackNode){var next=callbackNode.next;if(next===null){// Already cancelled.
return;}if(next===callbackNode){// This is the only scheduled callback. Clear the list.
firstCallbackNode=null;}else{// Remove the callback from its position in the list.
if(callbackNode===firstCallbackNode){firstCallbackNode=next;}var previous=callbackNode.previous;previous.next=next;next.previous=previous;}callbackNode.next=callbackNode.previous=null;}function unstable_getCurrentPriorityLevel(){return currentPriorityLevel;}function unstable_shouldYield(){return!currentDidTimeout&&(firstCallbackNode!==null&&firstCallbackNode.expirationTime<currentExpirationTime||shouldYieldToHost());}// The remaining code is essentially a polyfill for requestIdleCallback. It
...
var localSetTimeout=typeof setTimeout==='function'?setTimeout:undefined;var localClearTimeout=typeof clearTimeout==='function'?clearTimeout:undefined;// We don't expect either of these to necessarily be defined, but we will error
// later if they are missing on the client.
var localRequestAnimationFrame=typeof requestAnimationFrame==='function'?requestAnimationFrame:undefined;var localCancelAnimationFrame=typeof cancelAnimationFrame==='function'?cancelAnimationFrame:undefined;// requestAnimationFrame does not run when the tab is in the background. If
// we're backgrounded we prefer for that work to happen so that the page
// continues to load in the background. So we also schedule a 'setTimeout' as
// a fallback.
// TODO: Need a better heuristic for backgrounded work.
var ANIMATION_FRAME_TIMEOUT=100;var rAFID;var rAFTimeoutID;var requestAnimationFrameWithTimeout=function(callback){// schedule rAF and also a setTimeout
rAFID=localRequestAnimationFrame(function(timestamp){// cancel the setTimeout
localClearTimeout(rAFTimeoutID);callback(timestamp);});rAFTimeoutID=localSetTimeout(function(){// cancel the requestAnimationFrame
localCancelAnimationFrame(rAFID);callback(exports.unstable_now());},ANIMATION_FRAME_TIMEOUT);};if(hasNativePerformanceNow){var Performance=performance;exports.unstable_now=function(){return Performance.now();};}else{exports.unstable_now=function(){return localDate.now();};}var requestHostCallback;var cancelHostCallback;var shouldYieldToHost;var globalValue=null;if(typeof window!=='undefined'){globalValue=window;}else if(typeof commonjsGlobal!=='undefined'){globalValue=commonjsGlobal;}if(globalValue&&globalValue._schedMock){// Dynamic injection, only for testing purposes.
var globalImpl=globalValue._schedMock;requestHostCallback=globalImpl[0];cancelHostCallback=globalImpl[1];shouldYieldToHost=globalImpl[2];exports.unstable_now=globalImpl[3];}else if(// If Scheduler runs in a non-DOM environment, it falls back to a naive
...
var _callback=null;var _flushCallback=function(didTimeout){if(_callback!==null){try{_callback(didTimeout);}finally{_callback=null;}}};requestHostCallback=function(cb,ms){if(_callback!==null){// Protect against re-entrancy.
setTimeout(requestHostCallback,0,cb);}else{_callback=cb;setTimeout(_flushCallback,0,false);}};cancelHostCallback=function(){_callback=null;};shouldYieldToHost=function(){return false;};}else{if(typeof console!=='undefined'){// TODO: Remove fb.me link
if(typeof localRequestAnimationFrame!=='function'){console.error("This browser doesn't support requestAnimationFrame. "+'Make sure that you load a '+'polyfill in older browsers. https://fb.me/react-polyfills');}if(typeof localCancelAnimationFrame!=='function'){console.error("This browser doesn't support cancelAnimationFrame. "+'Make sure that you load a '+'polyfill in older browsers. https://fb.me/react-polyfills');}}var scheduledHostCallback=null;var isMessageEventScheduled=false;var timeoutTime=-1;var isAnimationFrameScheduled=false;var isFlushingHostCallback=false;var frameDeadline=0;// We start out assuming that we run at 30fps but then the heuristic tracking
// will adjust this value to a faster fps if we get more frequent animation
// frames.
var previousFrameTime=33;var activeFrameTime=33;shouldYieldToHost=function(){return frameDeadline<=exports.unstable_now();};// We use the postMessage trick to defer idle work until after the repaint.
var channel=new MessageChannel();var port=channel.port2;channel.port1.onmessage=function(event){isMessageEventScheduled=false;var prevScheduledCallback=scheduledHostCallback;var prevTimeoutTime=timeoutTime;scheduledHostCallback=null;timeoutTime=-1;var currentTime=exports.unstable_now();var didTimeout=false;if(frameDeadline-currentTime<=0){// There's no time left in this idle period. Check if the callback has
// a timeout and whether it's been exceeded.
if(prevTimeoutTime!==-1&&prevTimeoutTime<=currentTime){// Exceeded the timeout. Invoke the callback even though there's no
// time left.
didTimeout=true;}else{// No timeout.
if(!isAnimationFrameScheduled){// Schedule another animation callback so we retry later.
isAnimationFrameScheduled=true;requestAnimationFrameWithTimeout(animationTick);}// Exit without invoking the callback.
scheduledHostCallback=prevScheduledCallback;timeoutTime=prevTimeoutTime;return;}}if(prevScheduledCallback!==null){isFlushingHostCallback=true;try{prevScheduledCallback(didTimeout);}finally{isFlushingHostCallback=false;}}};var animationTick=function(rafTime){if(scheduledHostCallback!==null){// Eagerly schedule the next animation callback at the beginning of the
...
// after that.
requestAnimationFrameWithTimeout(animationTick);}else{// No pending work. Exit.
isAnimationFrameScheduled=false;return;}var nextFrameTime=rafTime-frameDeadline+activeFrameTime;if(nextFrameTime<activeFrameTime&&previousFrameTime<activeFrameTime){if(nextFrameTime<8){// Defensive coding. We don't support higher frame rates than 120hz.
...
port.postMessage(undefined);}else if(!isAnimationFrameScheduled){// If rAF didn't already schedule one, we need to schedule a frame.
// TODO: If this rAF doesn't materialize because the browser throttles, we
// might want to still have setTimeout trigger rIC as a backup to ensure
// that we keep performing work.
isAnimationFrameScheduled=true;requestAnimationFrameWithTimeout(animationTick);}};cancelHostCallback=function(){scheduledHostCallback=null;isMessageEventScheduled=false;timeoutTime=-1;};}exports.unstable_ImmediatePriority=ImmediatePriority;exports.unstable_UserBlockingPriority=UserBlockingPriority;exports.unstable_NormalPriority=NormalPriority;exports.unstable_IdlePriority=IdlePriority;exports.unstable_LowPriority=LowPriority;exports.unstable_runWithPriority=unstable_runWithPriority;exports.unstable_next=unstable_next;exports.unstable_scheduleCallback=unstable_scheduleCallback;exports.unstable_cancelCallback=unstable_cancelCallback;exports.unstable_wrapCallback=unstable_wrapCallback;exports.unstable_getCurrentPriorityLevel=unstable_getCurrentPriorityLevel;exports.unstable_shouldYield=unstable_shouldYield;exports.unstable_continueExecution=unstable_continueExecution;exports.unstable_pauseExecution=unstable_pauseExecution;exports.unstable_getFirstCallbackNode=unstable_getFirstCallbackNode;})();}});unwrapExports(scheduler_development);var scheduler_development_1=scheduler_development.unstable_now;var scheduler_development_2=scheduler_development.unstable_ImmediatePriority;var scheduler_development_3=scheduler_development.unstable_UserBlockingPriority;var scheduler_development_4=scheduler_development.unstable_NormalPriority;var scheduler_development_5=scheduler_development.unstable_IdlePriority;var scheduler_development_6=scheduler_development.unstable_LowPriority;var scheduler_development_7=scheduler_development.unstable_runWithPriority;var scheduler_development_8=scheduler_development.unstable_next;var scheduler_development_9=scheduler_development.unstable_scheduleCallback;var scheduler_development_10=scheduler_development.unstable_cancelCallback;var scheduler_development_11=scheduler_development.unstable_wrapCallback;var scheduler_development_12=scheduler_development.unstable_getCurrentPriorityLevel;var scheduler_development_13=scheduler_development.unstable_shouldYield;var scheduler_development_14=scheduler_development.unstable_continueExecution;var scheduler_development_15=scheduler_development.unstable_pauseExecution;var scheduler_development_16=scheduler_development.unstable_getFirstCallbackNode;var scheduler=createCommonjsModule(function(module){if(false){}else{module.exports=scheduler_development;}});var reactReconciler_production_min=createCommonjsModule(function(module){/** @license React v0.20.4
 ...
 */module.exports=function $$$reconciler($$$hostConfig){var aa=objectAssign,ba=react__WEBPACK_IMPORTED_MODULE_0___default.a;var n=scheduler;function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++];}));a.name="Invariant Violation";}a.framesToPop=1;throw a;}}function p(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)c+="&args[]="+encodeURIComponent(arguments[d+1]);ca(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c);}var da=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;da.hasOwnProperty("ReactCurrentDispatcher")||(da.ReactCurrentDispatcher={current:null});var x="function"===typeof Symbol&&Symbol.for,ea=x?Symbol.for("react.element"):60103,fa=x?Symbol.for("react.portal"):60106,ha=x?Symbol.for("react.fragment"):60107,ia=x?Symbol.for("react.strict_mode"):60108,ja=x?Symbol.for("react.profiler"):60114,ka=x?Symbol.for("react.provider"):60109,la=x?Symbol.for("react.context"):60110,ma=x?Symbol.for("react.concurrent_mode"):60111,na=x?Symbol.for("react.forward_ref"):60112,oa=x?Symbol.for("react.suspense"):60113,pa=x?Symbol.for("react.memo"):60115,qa=x?Symbol.for("react.lazy"):60116,ra="function"===typeof Symbol&&Symbol.iterator;function sa(a){if(null===a||"object"!==typeof a)return null;a=ra&&a[ra]||a["@@iterator"];return"function"===typeof a?a:null;}function ta(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;switch(a){case ma:return"ConcurrentMode";case ha:return"Fragment";case fa:return"Portal";case ja:return"Profiler";case ia:return"StrictMode";case oa:return"Suspense";}if("object"===typeof a)switch(a.$$typeof){case la:return"Context.Consumer";case ka:return"Context.Provider";case na:var b=a.render;b=b.displayName||b.name||"";return a.displayName||(""!==b?"ForwardRef("+b+")":"ForwardRef");case pa:return ta(a.type);case qa:if(a=1===a._status?a._result:null)return ta(a);}return null;}function ua(a){var b=a;if(a.alternate)for(;b.return;)b=b.return;else{if(0!==(b.effectTag&2))return 1;for(;b.return;)if(b=b.return,0!==(b.effectTag&2))return 1;}return 3===b.tag?2:3;}function va(a){2!==ua(a)?p("188"):void 0;}function wa(a){var b=a.alternate;if(!b)return b=ua(a),3===b?p("188"):void 0,1===b?null:a;for(var c=a,d=b;;){var e=c.return,f=e?e.alternate:null;if(!e||!f)break;if(e.child===f.child){for(var g=e.child;g;){if(g===c)return va(e),a;if(g===d)return va(e),b;g=g.sibling;}p("188");}if(c.return!==d.return)c=e,d=f;else{g=!1;for(var h=e.child;h;){if(h===c){g=!0;c=e;d=f;break;}if(h===d){g=!0;d=e;c=f;break;}h=h.sibling;}if(!g){for(h=f.child;h;){if(h===c){g=!0;c=f;d=e;break;}if(h===d){g=!0;d=f;c=e;break;}h=h.sibling;}g?void 0:p("189");}}c.alternate!==d?p("190"):void 0;}3!==c.tag?p("188"):void 0;return c.stateNode.current===c?a:b;}function xa(a){a=wa(a);if(!a)return null;for(var b=a;;){if(5===b.tag||6===b.tag)return b;if(b.child)b.child.return=b,b=b.child;else{if(b===a)break;for(;!b.sibling;){if(!b.return||b.return===a)return null;b=b.return;}b.sibling.return=b.return;b=b.sibling;}}return null;}function ya(a){a=wa(a);if(!a)return null;for(var b=a;;){if(5===b.tag||6===b.tag)return b;if(b.child&&4!==b.tag)b.child.return=b,b=b.child;else{if(b===a)break;for(;!b.sibling;){if(!b.return||b.return===a)return null;b=b.return;}b.sibling.return=b.return;b=b.sibling;}}return null;}var za=$$$hostConfig.getPublicInstance,Aa=$$$hostConfig.getRootHostContext,Ca=$$$hostConfig.getChildHostContext,Da=$$$hostConfig.prepareForCommit,Ea=$$$hostConfig.resetAfterCommit,Fa=$$$hostConfig.createInstance,Ga=$$$hostConfig.appendInitialChild,Ha=$$$hostConfig.finalizeInitialChildren,Ia=$$$hostConfig.prepareUpdate,Ja=$$$hostConfig.shouldSetTextContent,Ka=$$$hostConfig.shouldDeprioritizeSubtree,La=$$$hostConfig.createTextInstance,Ma=$$$hostConfig.scheduleDeferredCallback,Na=$$$hostConfig.cancelDeferredCallback,Oa=$$$hostConfig.shouldYield,Pa=$$$hostConfig.setTimeout,Qa=$$$hostConfig.clearTimeout,Ra=$$$hostConfig.noTimeout,Sa=$$$hostConfig.schedulePassiveEffects,Ta=$$$hostConfig.cancelPassiveEffects,Ua=$$$hostConfig.now,Va=$$$hostConfig.isPrimaryRenderer,Wa=$$$hostConfig.supportsMutation,Xa=$$$hostConfig.supportsPersistence,Ya=$$$hostConfig.supportsHydration,Za=$$$hostConfig.appendChild,$a=$$$hostConfig.appendChildToContainer,ab=$$$hostConfig.commitTextUpdate,bb=$$$hostConfig.commitMount,cb=$$$hostConfig.commitUpdate,db=$$$hostConfig.insertBefore,eb=$$$hostConfig.insertInContainerBefore,fb=$$$hostConfig.removeChild,gb=$$$hostConfig.removeChildFromContainer,hb=$$$hostConfig.resetTextContent,ib=$$$hostConfig.hideInstance,jb=$$$hostConfig.hideTextInstance,kb=$$$hostConfig.unhideInstance,lb=$$$hostConfig.unhideTextInstance,mb=$$$hostConfig.cloneInstance,nb=$$$hostConfig.createContainerChildSet,ob=$$$hostConfig.appendChildToContainerChildSet,pb=$$$hostConfig.finalizeContainerChildren,qb=$$$hostConfig.replaceContainerChildren,rb=$$$hostConfig.cloneHiddenInstance,sb=$$$hostConfig.cloneUnhiddenInstance,tb=$$$hostConfig.createHiddenTextInstance,ub=$$$hostConfig.canHydrateInstance,vb=$$$hostConfig.canHydrateTextInstance,wb=$$$hostConfig.getNextHydratableSibling,xb=$$$hostConfig.getFirstHydratableChild,yb=$$$hostConfig.hydrateInstance,zb=$$$hostConfig.hydrateTextInstance,Ab=/^(.*)[\\\/]/;function Bb(a){var b="";do{a:switch(a.tag){case 3:case 4:case 6:case 7:case 10:case 9:var c="";break a;default:var d=a._debugOwner,e=a._debugSource,f=ta(a.type);c=null;d&&(c=ta(d.type));d=f;f="";e?f=" (at "+e.fileName.replace(Ab,"")+":"+e.lineNumber+")":c&&(f=" (created by "+c+")");c="\n    in "+(d||"Unknown")+f;}b+=c;a=a.return;}while(a);return b;}var Cb=[],Db=-1;function z(a){0>Db||(a.current=Cb[Db],Cb[Db]=null,Db--);}function A(a,b){Db++;Cb[Db]=a.current;a.current=b;}var Eb={},B={current:Eb},C={current:!1},Fb=Eb;function Gb(a,b){var c=a.type.contextTypes;if(!c)return Eb;var d=a.stateNode;if(d&&d.__reactInternalMemoizedUnmaskedChildContext===b)return d.__reactInternalMemoizedMaskedChildContext;var e={},f;for(f in c)e[f]=b[f];d&&(a=a.stateNode,a.__reactInternalMemoizedUnmaskedChildContext=b,a.__reactInternalMemoizedMaskedChildContext=e);return e;}function E(a){a=a.childContextTypes;return null!==a&&void 0!==a;}function Hb(a){z(C);z(B);}function Ib(a){z(C);z(B);}function Jb(a,b,c){B.current!==Eb?p("168"):void 0;A(B,b);A(C,c);}function Kb(a,b,c){var d=a.stateNode;a=b.childContextTypes;if("function"!==typeof d.getChildContext)return c;d=d.getChildContext();for(var e in d)e in a?void 0:p("108",ta(b)||"Unknown",e);return aa({},c,d);}function Lb(a){var b=a.stateNode;b=b&&b.__reactInternalMemoizedMergedChildContext||Eb;Fb=B.current;A(B,b);A(C,C.current);return!0;}function Mb(a,b,c){var d=a.stateNode;d?void 0:p("169");c?(b=Kb(a,b,Fb),d.__reactInternalMemoizedMergedChildContext=b,z(C),z(B),A(B,b)):z(C);A(C,c);}var Nb=null,Ob=null;function Pb(a){return function(b){try{return a(b);}catch(c){}};}function Qb(a){if("undefined"===typeof __REACT_DEVTOOLS_GLOBAL_HOOK__)return!1;var b=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(b.isDisabled||!b.supportsFiber)return!0;try{var c=b.inject(a);Nb=Pb(function(a){return b.onCommitFiberRoot(c,a);});Ob=Pb(function(a){return b.onCommitFiberUnmount(c,a);});}catch(d){}return!0;}function Rb(a,b,c,d){this.tag=a;this.key=c;this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null;this.index=0;this.ref=null;this.pendingProps=b;this.contextDependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null;this.mode=d;this.effectTag=0;this.lastEffect=this.firstEffect=this.nextEffect=null;this.childExpirationTime=this.expirationTime=0;this.alternate=null;}function F(a,b,c,d){return new Rb(a,b,c,d);}function Sb(a){a=a.prototype;return!(!a||!a.isReactComponent);}function Tb(a){if("function"===typeof a)return Sb(a)?1:0;if(void 0!==a&&null!==a){a=a.$$typeof;if(a===na)return 11;if(a===pa)return 14;}return 2;}function Ub(a,b){var c=a.alternate;null===c?(c=F(a.tag,b,a.key,a.mode),c.elementType=a.elementType,c.type=a.type,c.stateNode=a.stateNode,c.alternate=a,a.alternate=c):(c.pendingProps=b,c.effectTag=0,c.nextEffect=null,c.firstEffect=null,c.lastEffect=null);c.childExpirationTime=a.childExpirationTime;c.expirationTime=a.expirationTime;c.child=a.child;c.memoizedProps=a.memoizedProps;c.memoizedState=a.memoizedState;c.updateQueue=a.updateQueue;c.contextDependencies=a.contextDependencies;c.sibling=a.sibling;c.index=a.index;c.ref=a.ref;return c;}function Vb(a,b,c,d,e,f){var g=2;d=a;if("function"===typeof a)Sb(a)&&(g=1);else if("string"===typeof a)g=5;else a:switch(a){case ha:return Wb(c.children,e,f,b);case ma:return Xb(c,e|3,f,b);case ia:return Xb(c,e|2,f,b);case ja:return a=F(12,c,b,e|4),a.elementType=ja,a.type=ja,a.expirationTime=f,a;case oa:return a=F(13,c,b,e),a.elementType=oa,a.type=oa,a.expirationTime=f,a;default:if("object"===typeof a&&null!==a)switch(a.$$typeof){case ka:g=10;break a;case la:g=9;break a;case na:g=11;break a;case pa:g=14;break a;case qa:g=16;d=null;break a;}p("130",null==a?a:typeof a,"");}b=F(g,c,b,e);b.elementType=a;b.type=d;b.expirationTime=f;return b;}function Wb(a,b,c,d){a=F(7,a,d,b);a.expirationTime=c;return a;}function Xb(a,b,c,d){a=F(8,a,d,b);b=0===(b&1)?ia:ma;a.elementType=b;a.type=b;a.expirationTime=c;return a;}function Yb(a,b,c){a=F(6,a,null,b);a.expirationTime=c;return a;}function Zb(a,b,c){b=F(4,null!==a.children?a.children:[],a.key,b);b.expirationTime=c;b.stateNode={containerInfo:a.containerInfo,pendingChildren:null,implementation:a.implementation};return b;}function $b(a,b){a.didError=!1;var c=a.earliestPendingTime;0===c?a.earliestPendingTime=a.latestPendingTime=b:c<b?a.earliestPendingTime=b:a.latestPendingTime>b&&(a.latestPendingTime=b);ac(b,a);}function bc(a,b){a.didError=!1;if(0===b)a.earliestPendingTime=0,a.latestPendingTime=0,a.earliestSuspendedTime=0,a.latestSuspendedTime=0,a.latestPingedTime=0;else{b<a.latestPingedTime&&(a.latestPingedTime=0);var c=a.latestPendingTime;0!==c&&(c>b?a.earliestPendingTime=a.latestPendingTime=0:a.earliestPendingTime>b&&(a.earliestPendingTime=a.latestPendingTime));c=a.earliestSuspendedTime;0===c?$b(a,b):b<a.latestSuspendedTime?(a.earliestSuspendedTime=0,a.latestSuspendedTime=0,a.latestPingedTime=0,$b(a,b)):b>c&&$b(a,b);}ac(0,a);}function cc(a,b){a.didError=!1;a.latestPingedTime>=b&&(a.latestPingedTime=0);var c=a.earliestPendingTime,d=a.latestPendingTime;c===b?a.earliestPendingTime=d===b?a.latestPendingTime=0:d:d===b&&(a.latestPendingTime=c);c=a.earliestSuspendedTime;d=a.latestSuspendedTime;0===c?a.earliestSuspendedTime=a.latestSuspendedTime=b:c<b?a.earliestSuspendedTime=b:d>b&&(a.latestSuspendedTime=b);ac(b,a);}function dc(a,b){var c=a.earliestPendingTime;a=a.earliestSuspendedTime;c>b&&(b=c);a>b&&(b=a);return b;}function ac(a,b){var c=b.earliestSuspendedTime,d=b.latestSuspendedTime,e=b.earliestPendingTime,f=b.latestPingedTime;e=0!==e?e:f;0===e&&(0===a||d<a)&&(e=d);a=e;0!==a&&c>a&&(a=c);b.nextExpirationTimeToWorkOn=e;b.expirationTime=a;}function ec(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b;}var fc=Object.prototype.hasOwnProperty;function gc(a,b){if(ec(a,b))return!0;if("object"!==typeof a||null===a||"object"!==typeof b||null===b)return!1;var c=Object.keys(a),d=Object.keys(b);if(c.length!==d.length)return!1;for(d=0;d<c.length;d++)if(!fc.call(b,c[d])||!ec(a[c[d]],b[c[d]]))return!1;return!0;}function G(a,b){if(a&&a.defaultProps){b=aa({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);}return b;}function hc(a){var b=a._result;switch(a._status){case 1:return b;case 2:throw b;case 0:throw b;default:a._status=0;b=a._ctor;b=b();b.then(function(b){0===a._status&&(b=b.default,a._status=1,a._result=b);},function(b){0===a._status&&(a._status=2,a._result=b);});switch(a._status){case 1:return a._result;case 2:throw a._result;}a._result=b;throw b;}}var ic=new ba.Component().refs;function jc(a,b,c,d){b=a.memoizedState;c=c(d,b);c=null===c||void 0===c?b:aa({},b,c);a.memoizedState=c;d=a.updateQueue;null!==d&&0===a.expirationTime&&(d.baseState=c);}var sc={isMounted:function(a){return(a=a._reactInternalFiber)?2===ua(a):!1;},enqueueSetState:function(a,b,c){a=a._reactInternalFiber;var d=kc();d=lc(d,a);var e=mc(d);e.payload=b;void 0!==c&&null!==c&&(e.callback=c);nc();oc(a,e);pc(a,d);},enqueueReplaceState:function(a,b,c){a=a._reactInternalFiber;var d=kc();d=lc(d,a);var e=mc(d);e.tag=qc;e.payload=b;void 0!==c&&null!==c&&(e.callback=c);nc();oc(a,e);pc(a,d);},enqueueForceUpdate:function(a,b){a=a._reactInternalFiber;var c=kc();c=lc(c,a);var d=mc(c);d.tag=rc;void 0!==b&&null!==b&&(d.callback=b);nc();oc(a,d);pc(a,c);}};function tc(a,b,c,d,e,f,g){a=a.stateNode;return"function"===typeof a.shouldComponentUpdate?a.shouldComponentUpdate(d,f,g):b.prototype&&b.prototype.isPureReactComponent?!gc(c,d)||!gc(e,f):!0;}function uc(a,b,c){var d=!1,e=Eb;var f=b.contextType;"object"===typeof f&&null!==f?f=H(f):(e=E(b)?Fb:B.current,d=b.contextTypes,f=(d=null!==d&&void 0!==d)?Gb(a,e):Eb);b=new b(c,f);a.memoizedState=null!==b.state&&void 0!==b.state?b.state:null;b.updater=sc;a.stateNode=b;b._reactInternalFiber=a;d&&(a=a.stateNode,a.__reactInternalMemoizedUnmaskedChildContext=e,a.__reactInternalMemoizedMaskedChildContext=f);return b;}function vc(a,b,c,d){a=b.state;"function"===typeof b.componentWillReceiveProps&&b.componentWillReceiveProps(c,d);"function"===typeof b.UNSAFE_componentWillReceiveProps&&b.UNSAFE_componentWillReceiveProps(c,d);b.state!==a&&sc.enqueueReplaceState(b,b.state,null);}function wc(a,b,c,d){var e=a.stateNode;e.props=c;e.state=a.memoizedState;e.refs=ic;var f=b.contextType;"object"===typeof f&&null!==f?e.context=H(f):(f=E(b)?Fb:B.current,e.context=Gb(a,f));f=a.updateQueue;null!==f&&(xc(a,f,c,e,d),e.state=a.memoizedState);f=b.getDerivedStateFromProps;"function"===typeof f&&(jc(a,b,f,c),e.state=a.memoizedState);"function"===typeof b.getDerivedStateFromProps||"function"===typeof e.getSnapshotBeforeUpdate||"function"!==typeof e.UNSAFE_componentWillMount&&"function"!==typeof e.componentWillMount||(b=e.state,"function"===typeof e.componentWillMount&&e.componentWillMount(),"function"===typeof e.UNSAFE_componentWillMount&&e.UNSAFE_componentWillMount(),b!==e.state&&sc.enqueueReplaceState(e,e.state,null),f=a.updateQueue,null!==f&&(xc(a,f,c,e,d),e.state=a.memoizedState));"function"===typeof e.componentDidMount&&(a.effectTag|=4);}var yc=Array.isArray;function zc(a,b,c){a=c.ref;if(null!==a&&"function"!==typeof a&&"object"!==typeof a){if(c._owner){c=c._owner;var d=void 0;c&&(1!==c.tag?p("309"):void 0,d=c.stateNode);d?void 0:p("147",a);var e=""+a;if(null!==b&&null!==b.ref&&"function"===typeof b.ref&&b.ref._stringRef===e)return b.ref;b=function(b){var a=d.refs;a===ic&&(a=d.refs={});null===b?delete a[e]:a[e]=b;};b._stringRef=e;return b;}"string"!==typeof a?p("284"):void 0;c._owner?void 0:p("290",a);}return a;}function Ac(a,b){"textarea"!==a.type&&p("31","[object Object]"===Object.prototype.toString.call(b)?"object with keys {"+Object.keys(b).join(", ")+"}":b,"");}function Bc(a){function b(b,c){if(a){var d=b.lastEffect;null!==d?(d.nextEffect=c,b.lastEffect=c):b.firstEffect=b.lastEffect=c;c.nextEffect=null;c.effectTag=8;}}function c(c,d){if(!a)return null;for(;null!==d;)b(c,d),d=d.sibling;return null;}function d(b,a){for(b=new Map();null!==a;)null!==a.key?b.set(a.key,a):b.set(a.index,a),a=a.sibling;return b;}function e(b,a,c){b=Ub(b,a);b.index=0;b.sibling=null;return b;}function f(b,c,d){b.index=d;if(!a)return c;d=b.alternate;if(null!==d)return d=d.index,d<c?(b.effectTag=2,c):d;b.effectTag=2;return c;}function g(b){a&&null===b.alternate&&(b.effectTag=2);return b;}function h(b,a,c,d){if(null===a||6!==a.tag)return a=Yb(c,b.mode,d),a.return=b,a;a=e(a,c);a.return=b;return a;}function k(b,a,c,d){if(null!==a&&a.elementType===c.type)return d=e(a,c.props),d.ref=zc(b,a,c),d.return=b,d;d=Vb(c.type,c.key,c.props,null,b.mode,d);d.ref=zc(b,a,c);d.return=b;return d;}function l(b,a,c,d){if(null===a||4!==a.tag||a.stateNode.containerInfo!==c.containerInfo||a.stateNode.implementation!==c.implementation)return a=Zb(c,b.mode,d),a.return=b,a;a=e(a,c.children||[]);a.return=b;return a;}function m(b,a,c,d,g){if(null===a||7!==a.tag)return a=Wb(c,b.mode,d,g),a.return=b,a;a=e(a,c);a.return=b;return a;}function v(b,a,c){if("string"===typeof a||"number"===typeof a)return a=Yb(""+a,b.mode,c),a.return=b,a;if("object"===typeof a&&null!==a){switch(a.$$typeof){case ea:return c=Vb(a.type,a.key,a.props,null,b.mode,c),c.ref=zc(b,null,a),c.return=b,c;case fa:return a=Zb(a,b.mode,c),a.return=b,a;}if(yc(a)||sa(a))return a=Wb(a,b.mode,c,null),a.return=b,a;Ac(b,a);}return null;}function w(b,a,c,d){var e=null!==a?a.key:null;if("string"===typeof c||"number"===typeof c)return null!==e?null:h(b,a,""+c,d);if("object"===typeof c&&null!==c){switch(c.$$typeof){case ea:return c.key===e?c.type===ha?m(b,a,c.props.children,d,e):k(b,a,c,d):null;case fa:return c.key===e?l(b,a,c,d):null;}if(yc(c)||sa(c))return null!==e?null:m(b,a,c,d,null);Ac(b,c);}return null;}function D(b,a,c,d,e){if("string"===typeof d||"number"===typeof d)return b=b.get(c)||null,h(a,b,""+d,e);if("object"===typeof d&&null!==d){switch(d.$$typeof){case ea:return b=b.get(null===d.key?c:d.key)||null,d.type===ha?m(a,b,d.props.children,e,d.key):k(a,b,d,e);case fa:return b=b.get(null===d.key?c:d.key)||null,l(a,b,d,e);}if(yc(d)||sa(d))return b=b.get(c)||null,m(a,b,d,e,null);Ac(a,d);}return null;}function t(e,g,h,l){for(var k=null,m=null,q=g,u=g=0,y=null;null!==q&&u<h.length;u++){q.index>u?(y=q,q=null):y=q.sibling;var r=w(e,q,h[u],l);if(null===r){null===q&&(q=y);break;}a&&q&&null===r.alternate&&b(e,q);g=f(r,g,u);null===m?k=r:m.sibling=r;m=r;q=y;}if(u===h.length)return c(e,q),k;if(null===q){for(;u<h.length;u++)if(q=v(e,h[u],l))g=f(q,g,u),null===m?k=q:m.sibling=q,m=q;return k;}for(q=d(e,q);u<h.length;u++)if(y=D(q,e,u,h[u],l))a&&null!==y.alternate&&q.delete(null===y.key?u:y.key),g=f(y,g,u),null===m?k=y:m.sibling=y,m=y;a&&q.forEach(function(a){return b(e,a);});return k;}function Ba(e,g,h,l){var k=sa(h);"function"!==typeof k?p("150"):void 0;h=k.call(h);null==h?p("151"):void 0;for(var m=k=null,q=g,u=g=0,y=null,r=h.next();null!==q&&!r.done;u++,r=h.next()){q.index>u?(y=q,q=null):y=q.sibling;var t=w(e,q,r.value,l);if(null===t){q||(q=y);break;}a&&q&&null===t.alternate&&b(e,q);g=f(t,g,u);null===m?k=t:m.sibling=t;m=t;q=y;}if(r.done)return c(e,q),k;if(null===q){for(;!r.done;u++,r=h.next())r=v(e,r.value,l),null!==r&&(g=f(r,g,u),null===m?k=r:m.sibling=r,m=r);return k;}for(q=d(e,q);!r.done;u++,r=h.next())r=D(q,e,u,r.value,l),null!==r&&(a&&null!==r.alternate&&q.delete(null===r.key?u:r.key),g=f(r,g,u),null===m?k=r:m.sibling=r,m=r);a&&q.forEach(function(a){return b(e,a);});return k;}return function(a,d,f,h){var k="object"===typeof f&&null!==f&&f.type===ha&&null===f.key;k&&(f=f.props.children);var l="object"===typeof f&&null!==f;if(l)switch(f.$$typeof){case ea:a:{l=f.key;for(k=d;null!==k;){if(k.key===l){if(7===k.tag?f.type===ha:k.elementType===f.type){c(a,k.sibling);d=e(k,f.type===ha?f.props.children:f.props);d.ref=zc(a,k,f);d.return=a;a=d;break a;}else{c(a,k);break;}}else b(a,k);k=k.sibling;}f.type===ha?(d=Wb(f.props.children,a.mode,h,f.key),d.return=a,a=d):(h=Vb(f.type,f.key,f.props,null,a.mode,h),h.ref=zc(a,d,f),h.return=a,a=h);}return g(a);case fa:a:{for(k=f.key;null!==d;){if(d.key===k){if(4===d.tag&&d.stateNode.containerInfo===f.containerInfo&&d.stateNode.implementation===f.implementation){c(a,d.sibling);d=e(d,f.children||[]);d.return=a;a=d;break a;}else{c(a,d);break;}}else b(a,d);d=d.sibling;}d=Zb(f,a.mode,h);d.return=a;a=d;}return g(a);}if("string"===typeof f||"number"===typeof f)return f=""+f,null!==d&&6===d.tag?(c(a,d.sibling),d=e(d,f),d.return=a,a=d):(c(a,d),d=Yb(f,a.mode,h),d.return=a,a=d),g(a);if(yc(f))return t(a,d,f,h);if(sa(f))return Ba(a,d,f,h);l&&Ac(a,f);if("undefined"===typeof f&&!k)switch(a.tag){case 1:case 0:h=a.type,p("152",h.displayName||h.name||"Component");}return c(a,d);};}var Cc=Bc(!0),Dc=Bc(!1),Ec={},Fc={current:Ec},Gc={current:Ec},Hc={current:Ec};function Ic(a){a===Ec?p("174"):void 0;return a;}function Jc(a,b){A(Hc,b);A(Gc,a);A(Fc,Ec);b=Aa(b);z(Fc);A(Fc,b);}function Kc(a){z(Fc);z(Gc);z(Hc);}function Lc(){return Ic(Fc.current);}function Mc(a){var b=Ic(Hc.current),c=Ic(Fc.current);b=Ca(c,a.type,b);c!==b&&(A(Gc,a),A(Fc,b));}function Nc(a){Gc.current===a&&(z(Fc),z(Gc));}var Oc=0,Pc=2,Qc=4,Rc=8,Sc=16,Tc=32,Uc=64,Vc=128,Wc=da.ReactCurrentDispatcher,Xc=0,Yc=null,I=null,J=null,Zc=null,K=null,$c=null,ad=0,L=null,bd=0,cd=!1,dd=null,ed=0;function M(){p("321");}function fd(a,b){if(null===b)return!1;for(var c=0;c<b.length&&c<a.length;c++)if(!ec(a[c],b[c]))return!1;return!0;}function gd(a,b,c,d,e,f){Xc=f;Yc=b;J=null!==a?a.memoizedState:null;Wc.current=null===J?hd:id;b=c(d,e);if(cd){do cd=!1,ed+=1,J=null!==a?a.memoizedState:null,$c=Zc,L=K=I=null,Wc.current=id,b=c(d,e);while(cd);dd=null;ed=0;}Wc.current=jd;a=Yc;a.memoizedState=Zc;a.expirationTime=ad;a.updateQueue=L;a.effectTag|=bd;a=null!==I&&null!==I.next;Xc=0;$c=K=Zc=J=I=Yc=null;ad=0;L=null;bd=0;a?p("300"):void 0;return b;}function kd(){Wc.current=jd;Xc=0;$c=K=Zc=J=I=Yc=null;ad=0;L=null;bd=0;cd=!1;dd=null;ed=0;}function ld(){var a={memoizedState:null,baseState:null,queue:null,baseUpdate:null,next:null};null===K?Zc=K=a:K=K.next=a;return K;}function md(){if(null!==$c)K=$c,$c=K.next,I=J,J=null!==I?I.next:null;else{null===J?p("310"):void 0;I=J;var a={memoizedState:I.memoizedState,baseState:I.baseState,queue:I.queue,baseUpdate:I.baseUpdate,next:null};K=null===K?Zc=a:K.next=a;J=I.next;}return K;}function nd(a,b){return"function"===typeof b?b(a):b;}function od(a){var b=md(),c=b.queue;null===c?p("311"):void 0;c.lastRenderedReducer=a;if(0<ed){var d=c.dispatch;if(null!==dd){var e=dd.get(c);if(void 0!==e){dd.delete(c);var f=b.memoizedState;do f=a(f,e.action),e=e.next;while(null!==e);ec(f,b.memoizedState)||(pd=!0);b.memoizedState=f;b.baseUpdate===c.last&&(b.baseState=f);c.lastRenderedState=f;return[f,d];}}return[b.memoizedState,d];}d=c.last;var g=b.baseUpdate;f=b.baseState;null!==g?(null!==d&&(d.next=null),d=g.next):d=null!==d?d.next:null;if(null!==d){var h=e=null,k=d,l=!1;do{var m=k.expirationTime;m<Xc?(l||(l=!0,h=g,e=f),m>ad&&(ad=m)):f=k.eagerReducer===a?k.eagerState:a(f,k.action);g=k;k=k.next;}while(null!==k&&k!==d);l||(h=g,e=f);ec(f,b.memoizedState)||(pd=!0);b.memoizedState=f;b.baseUpdate=h;b.baseState=e;c.lastRenderedState=f;}return[b.memoizedState,c.dispatch];}function qd(a,b,c,d){a={tag:a,create:b,destroy:c,deps:d,next:null};null===L?(L={lastEffect:null},L.lastEffect=a.next=a):(b=L.lastEffect,null===b?L.lastEffect=a.next=a:(c=b.next,b.next=a,a.next=c,L.lastEffect=a));return a;}function rd(a,b,c,d){var e=ld();bd|=a;e.memoizedState=qd(b,c,void 0,void 0===d?null:d);}function sd(a,b,c,d){var e=md();d=void 0===d?null:d;var f=void 0;if(null!==I){var g=I.memoizedState;f=g.destroy;if(null!==d&&fd(d,g.deps)){qd(Oc,c,f,d);return;}}bd|=a;e.memoizedState=qd(b,c,f,d);}function td(a,b){if("function"===typeof b)return a=a(),b(a),function(){b(null);};if(null!==b&&void 0!==b)return a=a(),b.current=a,function(){b.current=null;};}function ud(){}function vd(a,b,c){25>ed?void 0:p("301");var d=a.alternate;if(a===Yc||null!==d&&d===Yc){if(cd=!0,a={expirationTime:Xc,action:c,eagerReducer:null,eagerState:null,next:null},null===dd&&(dd=new Map()),c=dd.get(b),void 0===c)dd.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a;}}else{nc();var e=kc();e=lc(e,a);var f={expirationTime:e,action:c,eagerReducer:null,eagerState:null,next:null},g=b.last;if(null===g)f.next=f;else{var h=g.next;null!==h&&(f.next=h);g.next=f;}b.last=f;if(0===a.expirationTime&&(null===d||0===d.expirationTime)&&(d=b.lastRenderedReducer,null!==d))try{var k=b.lastRenderedState,l=d(k,c);f.eagerReducer=d;f.eagerState=l;if(ec(l,k))return;}catch(m){}finally{}pc(a,e);}}var jd={readContext:H,useCallback:M,useContext:M,useEffect:M,useImperativeHandle:M,useLayoutEffect:M,useMemo:M,useReducer:M,useRef:M,useState:M,useDebugValue:M},hd={readContext:H,useCallback:function(a,b){ld().memoizedState=[a,void 0===b?null:b];return a;},useContext:H,useEffect:function(a,b){return rd(516,Vc|Uc,a,b);},useImperativeHandle:function(a,b,c){c=null!==c&&void 0!==c?c.concat([a]):null;return rd(4,Qc|Tc,td.bind(null,b,a),c);},useLayoutEffect:function(a,b){return rd(4,Qc|Tc,a,b);},useMemo:function(a,b){var c=ld();b=void 0===b?null:b;a=a();c.memoizedState=[a,b];return a;},useReducer:function(a,b,c){var d=ld();b=void 0!==c?c(b):b;d.memoizedState=d.baseState=b;a=d.queue={last:null,dispatch:null,lastRenderedReducer:a,lastRenderedState:b};a=a.dispatch=vd.bind(null,Yc,a);return[d.memoizedState,a];},useRef:function(a){var b=ld();a={current:a};return b.memoizedState=a;},useState:function(a){var b=ld();"function"===typeof a&&(a=a());b.memoizedState=b.baseState=a;a=b.queue={last:null,dispatch:null,lastRenderedReducer:nd,lastRenderedState:a};a=a.dispatch=vd.bind(null,Yc,a);return[b.memoizedState,a];},useDebugValue:ud},id={readContext:H,useCallback:function(a,b){var c=md();b=void 0===b?null:b;var d=c.memoizedState;if(null!==d&&null!==b&&fd(b,d[1]))return d[0];c.memoizedState=[a,b];return a;},useContext:H,useEffect:function(a,b){return sd(516,Vc|Uc,a,b);},useImperativeHandle:function(a,b,c){c=null!==c&&void 0!==c?c.concat([a]):null;return sd(4,Qc|Tc,td.bind(null,b,a),c);},useLayoutEffect:function(a,b){return sd(4,Qc|Tc,a,b);},useMemo:function(a,b){var c=md();b=void 0===b?null:b;var d=c.memoizedState;if(null!==d&&null!==b&&fd(b,d[1]))return d[0];a=a();c.memoizedState=[a,b];return a;},useReducer:od,useRef:function(){return md().memoizedState;},useState:function(a){return od(nd);},useDebugValue:ud},wd=null,xd=null,yd=!1;function zd(a,b){var c=F(5,null,null,0);c.elementType="DELETED";c.type="DELETED";c.stateNode=b;c.return=a;c.effectTag=8;null!==a.lastEffect?(a.lastEffect.nextEffect=c,a.lastEffect=c):a.firstEffect=a.lastEffect=c;}function Ad(a,b){switch(a.tag){case 5:return b=ub(b,a.type,a.pendingProps),null!==b?(a.stateNode=b,!0):!1;case 6:return b=vb(b,a.pendingProps),null!==b?(a.stateNode=b,!0):!1;case 13:return!1;default:return!1;}}function Bd(a){if(yd){var b=xd;if(b){var c=b;if(!Ad(a,b)){b=wb(c);if(!b||!Ad(a,b)){a.effectTag|=2;yd=!1;wd=a;return;}zd(wd,c);}wd=a;xd=xb(b);}else a.effectTag|=2,yd=!1,wd=a;}}function Cd(a){for(a=a.return;null!==a&&5!==a.tag&&3!==a.tag&&18!==a.tag;)a=a.return;wd=a;}function Dd(a){if(!Ya||a!==wd)return!1;if(!yd)return Cd(a),yd=!0,!1;var b=a.type;if(5!==a.tag||"head"!==b&&"body"!==b&&!Ja(b,a.memoizedProps))for(b=xd;b;)zd(a,b),b=wb(b);Cd(a);xd=wd?wb(a.stateNode):null;return!0;}function Ed(){Ya&&(xd=wd=null,yd=!1);}var Fd=da.ReactCurrentOwner,pd=!1;function N(a,b,c,d){b.child=null===a?Dc(b,null,c,d):Cc(b,a.child,c,d);}function Gd(a,b,c,d,e){c=c.render;var f=b.ref;Hd(b,e);d=gd(a,b,c,d,f,e);if(null!==a&&!pd)return b.updateQueue=a.updateQueue,b.effectTag&=-517,a.expirationTime<=e&&(a.expirationTime=0),Id(a,b,e);b.effectTag|=1;N(a,b,d,e);return b.child;}function Jd(a,b,c,d,e,f){if(null===a){var g=c.type;if("function"===typeof g&&!Sb(g)&&void 0===g.defaultProps&&null===c.compare&&void 0===c.defaultProps)return b.tag=15,b.type=g,Kd(a,b,g,d,e,f);a=Vb(c.type,null,d,null,b.mode,f);a.ref=b.ref;a.return=b;return b.child=a;}g=a.child;if(e<f&&(e=g.memoizedProps,c=c.compare,c=null!==c?c:gc,c(e,d)&&a.ref===b.ref))return Id(a,b,f);b.effectTag|=1;a=Ub(g,d);a.ref=b.ref;a.return=b;return b.child=a;}function Kd(a,b,c,d,e,f){return null!==a&&gc(a.memoizedProps,d)&&a.ref===b.ref&&(pd=!1,e<f)?Id(a,b,f):Ld(a,b,c,d,f);}function Md(a,b){var c=b.ref;if(null===a&&null!==c||null!==a&&a.ref!==c)b.effectTag|=128;}function Ld(a,b,c,d,e){var f=E(c)?Fb:B.current;f=Gb(b,f);Hd(b,e);c=gd(a,b,c,d,f,e);if(null!==a&&!pd)return b.updateQueue=a.updateQueue,b.effectTag&=-517,a.expirationTime<=e&&(a.expirationTime=0),Id(a,b,e);b.effectTag|=1;N(a,b,c,e);return b.child;}function Nd(a,b,c,d,e){if(E(c)){var f=!0;Lb(b);}else f=!1;Hd(b,e);if(null===b.stateNode)null!==a&&(a.alternate=null,b.alternate=null,b.effectTag|=2),uc(b,c,d),wc(b,c,d,e),d=!0;else if(null===a){var g=b.stateNode,h=b.memoizedProps;g.props=h;var k=g.context,l=c.contextType;"object"===typeof l&&null!==l?l=H(l):(l=E(c)?Fb:B.current,l=Gb(b,l));var m=c.getDerivedStateFromProps,v="function"===typeof m||"function"===typeof g.getSnapshotBeforeUpdate;v||"function"!==typeof g.UNSAFE_componentWillReceiveProps&&"function"!==typeof g.componentWillReceiveProps||(h!==d||k!==l)&&vc(b,g,d,l);Od=!1;var w=b.memoizedState;k=g.state=w;var D=b.updateQueue;null!==D&&(xc(b,D,d,g,e),k=b.memoizedState);h!==d||w!==k||C.current||Od?("function"===typeof m&&(jc(b,c,m,d),k=b.memoizedState),(h=Od||tc(b,c,h,d,w,k,l))?(v||"function"!==typeof g.UNSAFE_componentWillMount&&"function"!==typeof g.componentWillMount||("function"===typeof g.componentWillMount&&g.componentWillMount(),"function"===typeof g.UNSAFE_componentWillMount&&g.UNSAFE_componentWillMount()),"function"===typeof g.componentDidMount&&(b.effectTag|=4)):("function"===typeof g.componentDidMount&&(b.effectTag|=4),b.memoizedProps=d,b.memoizedState=k),g.props=d,g.state=k,g.context=l,d=h):("function"===typeof g.componentDidMount&&(b.effectTag|=4),d=!1);}else g=b.stateNode,h=b.memoizedProps,g.props=b.type===b.elementType?h:G(b.type,h),k=g.context,l=c.contextType,"object"===typeof l&&null!==l?l=H(l):(l=E(c)?Fb:B.current,l=Gb(b,l)),m=c.getDerivedStateFromProps,(v="function"===typeof m||"function"===typeof g.getSnapshotBeforeUpdate)||"function"!==typeof g.UNSAFE_componentWillReceiveProps&&"function"!==typeof g.componentWillReceiveProps||(h!==d||k!==l)&&vc(b,g,d,l),Od=!1,k=b.memoizedState,w=g.state=k,D=b.updateQueue,null!==D&&(xc(b,D,d,g,e),w=b.memoizedState),h!==d||k!==w||C.current||Od?("function"===typeof m&&(jc(b,c,m,d),w=b.memoizedState),(m=Od||tc(b,c,h,d,k,w,l))?(v||"function"!==typeof g.UNSAFE_componentWillUpdate&&"function"!==typeof g.componentWillUpdate||("function"===typeof g.componentWillUpdate&&g.componentWillUpdate(d,w,l),"function"===typeof g.UNSAFE_componentWillUpdate&&g.UNSAFE_componentWillUpdate(d,w,l)),"function"===typeof g.componentDidUpdate&&(b.effectTag|=4),"function"===typeof g.getSnapshotBeforeUpdate&&(b.effectTag|=256)):("function"!==typeof g.componentDidUpdate||h===a.memoizedProps&&k===a.memoizedState||(b.effectTag|=4),"function"!==typeof g.getSnapshotBeforeUpdate||h===a.memoizedProps&&k===a.memoizedState||(b.effectTag|=256),b.memoizedProps=d,b.memoizedState=w),g.props=d,g.state=w,g.context=l,d=m):("function"!==typeof g.componentDidUpdate||h===a.memoizedProps&&k===a.memoizedState||(b.effectTag|=4),"function"!==typeof g.getSnapshotBeforeUpdate||h===a.memoizedProps&&k===a.memoizedState||(b.effectTag|=256),d=!1);return Pd(a,b,c,d,f,e);}function Pd(a,b,c,d,e,f){Md(a,b);var g=0!==(b.effectTag&64);if(!d&&!g)return e&&Mb(b,c,!1),Id(a,b,f);d=b.stateNode;Fd.current=b;var h=g&&"function"!==typeof c.getDerivedStateFromError?null:d.render();b.effectTag|=1;null!==a&&g?(b.child=Cc(b,a.child,null,f),b.child=Cc(b,null,h,f)):N(a,b,h,f);b.memoizedState=d.state;e&&Mb(b,c,!0);return b.child;}function Qd(a){var b=a.stateNode;b.pendingContext?Jb(a,b.pendingContext,b.pendingContext!==b.context):b.context&&Jb(a,b.context,!1);Jc(a,b.containerInfo);}function Rd(a,b,c){var d=b.mode,e=b.pendingProps,f=b.memoizedState;if(0===(b.effectTag&64)){f=null;var g=!1;}else f={timedOutAt:null!==f?f.timedOutAt:0},g=!0,b.effectTag&=-65;if(null===a){if(g){var h=e.fallback;a=Wb(null,d,0,null);0===(b.mode&1)&&(a.child=null!==b.memoizedState?b.child.child:b.child);d=Wb(h,d,c,null);a.sibling=d;c=a;c.return=d.return=b;}else c=d=Dc(b,null,e.children,c);}else null!==a.memoizedState?(d=a.child,h=d.sibling,g?(c=e.fallback,e=Ub(d,d.pendingProps),0===(b.mode&1)&&(g=null!==b.memoizedState?b.child.child:b.child,g!==d.child&&(e.child=g)),d=e.sibling=Ub(h,c,h.expirationTime),c=e,e.childExpirationTime=0,c.return=d.return=b):c=d=Cc(b,d.child,e.children,c)):(h=a.child,g?(g=e.fallback,e=Wb(null,d,0,null),e.child=h,0===(b.mode&1)&&(e.child=null!==b.memoizedState?b.child.child:b.child),d=e.sibling=Wb(g,d,c,null),d.effectTag|=2,c=e,e.childExpirationTime=0,c.return=d.return=b):d=c=Cc(b,h,e.children,c)),b.stateNode=a.stateNode;b.memoizedState=f;b.child=c;return d;}function Id(a,b,c){null!==a&&(b.contextDependencies=a.contextDependencies);if(b.childExpirationTime<c)return null;null!==a&&b.child!==a.child?p("153"):void 0;if(null!==b.child){a=b.child;c=Ub(a,a.pendingProps,a.expirationTime);b.child=c;for(c.return=b;null!==a.sibling;)a=a.sibling,c=c.sibling=Ub(a,a.pendingProps,a.expirationTime),c.return=b;c.sibling=null;}return b.child;}function Sd(a,b,c){var d=b.expirationTime;if(null!==a){if(a.memoizedProps!==b.pendingProps||C.current)pd=!0;else{if(d<c){pd=!1;switch(b.tag){case 3:Qd(b);Ed();break;case 5:Mc(b);break;case 1:E(b.type)&&Lb(b);break;case 4:Jc(b,b.stateNode.containerInfo);break;case 10:Td(b,b.memoizedProps.value);break;case 13:if(null!==b.memoizedState){d=b.child.childExpirationTime;if(0!==d&&d>=c)return Rd(a,b,c);b=Id(a,b,c);return null!==b?b.sibling:null;}}return Id(a,b,c);}}}else pd=!1;b.expirationTime=0;switch(b.tag){case 2:d=b.elementType;null!==a&&(a.alternate=null,b.alternate=null,b.effectTag|=2);a=b.pendingProps;var e=Gb(b,B.current);Hd(b,c);e=gd(null,b,d,a,e,c);b.effectTag|=1;if("object"===typeof e&&null!==e&&"function"===typeof e.render&&void 0===e.$$typeof){b.tag=1;kd();if(E(d)){var f=!0;Lb(b);}else f=!1;b.memoizedState=null!==e.state&&void 0!==e.state?e.state:null;var g=d.getDerivedStateFromProps;"function"===typeof g&&jc(b,d,g,a);e.updater=sc;b.stateNode=e;e._reactInternalFiber=b;wc(b,d,a,c);b=Pd(null,b,d,!0,f,c);}else b.tag=0,N(null,b,e,c),b=b.child;return b;case 16:e=b.elementType;null!==a&&(a.alternate=null,b.alternate=null,b.effectTag|=2);f=b.pendingProps;a=hc(e);b.type=a;e=b.tag=Tb(a);f=G(a,f);g=void 0;switch(e){case 0:g=Ld(null,b,a,f,c);break;case 1:g=Nd(null,b,a,f,c);break;case 11:g=Gd(null,b,a,f,c);break;case 14:g=Jd(null,b,a,G(a.type,f),d,c);break;default:p("306",a,"");}return g;case 0:return d=b.type,e=b.pendingProps,e=b.elementType===d?e:G(d,e),Ld(a,b,d,e,c);case 1:return d=b.type,e=b.pendingProps,e=b.elementType===d?e:G(d,e),Nd(a,b,d,e,c);case 3:Qd(b);d=b.updateQueue;null===d?p("282"):void 0;e=b.memoizedState;e=null!==e?e.element:null;xc(b,d,b.pendingProps,null,c);d=b.memoizedState.element;if(d===e)Ed(),b=Id(a,b,c);else{e=b.stateNode;if(e=(null===a||null===a.child)&&e.hydrate)Ya?(xd=xb(b.stateNode.containerInfo),wd=b,e=yd=!0):e=!1;e?(b.effectTag|=2,b.child=Dc(b,null,d,c)):(N(a,b,d,c),Ed());b=b.child;}return b;case 5:return Mc(b),null===a&&Bd(b),d=b.type,e=b.pendingProps,f=null!==a?a.memoizedProps:null,g=e.children,Ja(d,e)?g=null:null!==f&&Ja(d,f)&&(b.effectTag|=16),Md(a,b),1!==c&&b.mode&1&&Ka(d,e)?(b.expirationTime=b.childExpirationTime=1,b=null):(N(a,b,g,c),b=b.child),b;case 6:return null===a&&Bd(b),null;case 13:return Rd(a,b,c);case 4:return Jc(b,b.stateNode.containerInfo),d=b.pendingProps,null===a?b.child=Cc(b,null,d,c):N(a,b,d,c),b.child;case 11:return d=b.type,e=b.pendingProps,e=b.elementType===d?e:G(d,e),Gd(a,b,d,e,c);case 7:return N(a,b,b.pendingProps,c),b.child;case 8:return N(a,b,b.pendingProps.children,c),b.child;case 12:return N(a,b,b.pendingProps.children,c),b.child;case 10:a:{d=b.type._context;e=b.pendingProps;g=b.memoizedProps;f=e.value;Td(b,f);if(null!==g){var h=g.value;f=ec(h,f)?0:("function"===typeof d._calculateChangedBits?d._calculateChangedBits(h,f):1073741823)|0;if(0===f){if(g.children===e.children&&!C.current){b=Id(a,b,c);break a;}}else for(h=b.child,null!==h&&(h.return=b);null!==h;){var k=h.contextDependencies;if(null!==k){g=h.child;for(var l=k.first;null!==l;){if(l.context===d&&0!==(l.observedBits&f)){1===h.tag&&(l=mc(c),l.tag=rc,oc(h,l));h.expirationTime<c&&(h.expirationTime=c);l=h.alternate;null!==l&&l.expirationTime<c&&(l.expirationTime=c);l=c;for(var m=h.return;null!==m;){var v=m.alternate;if(m.childExpirationTime<l)m.childExpirationTime=l,null!==v&&v.childExpirationTime<l&&(v.childExpirationTime=l);else if(null!==v&&v.childExpirationTime<l)v.childExpirationTime=l;else break;m=m.return;}k.expirationTime<c&&(k.expirationTime=c);break;}l=l.next;}}else g=10===h.tag?h.type===b.type?null:h.child:h.child;if(null!==g)g.return=h;else for(g=h;null!==g;){if(g===b){g=null;break;}h=g.sibling;if(null!==h){h.return=g.return;g=h;break;}g=g.return;}h=g;}}N(a,b,e.children,c);b=b.child;}return b;case 9:return e=b.type,f=b.pendingProps,d=f.children,Hd(b,c),e=H(e,f.unstable_observedBits),d=d(e),b.effectTag|=1,N(a,b,d,c),b.child;case 14:return e=b.type,f=G(e,b.pendingProps),f=G(e.type,f),Jd(a,b,e,f,d,c);case 15:return Kd(a,b,b.type,b.pendingProps,d,c);case 17:return d=b.type,e=b.pendingProps,e=b.elementType===d?e:G(d,e),null!==a&&(a.alternate=null,b.alternate=null,b.effectTag|=2),b.tag=1,E(d)?(a=!0,Lb(b)):a=!1,Hd(b,c),uc(b,d,e),wc(b,d,e,c),Pd(null,b,d,!0,a,c);}p("156");}var Ud={current:null},Vd=null,Wd=null,Xd=null;function Td(a,b){var c=a.type._context;Va?(A(Ud,c._currentValue),c._currentValue=b):(A(Ud,c._currentValue2),c._currentValue2=b);}function Yd(a){var b=Ud.current;z(Ud);a=a.type._context;Va?a._currentValue=b:a._currentValue2=b;}function Hd(a,b){Vd=a;Xd=Wd=null;var c=a.contextDependencies;null!==c&&c.expirationTime>=b&&(pd=!0);a.contextDependencies=null;}function H(a,b){if(Xd!==a&&!1!==b&&0!==b){if("number"!==typeof b||1073741823===b)Xd=a,b=1073741823;b={context:a,observedBits:b,next:null};null===Wd?(null===Vd?p("308"):void 0,Wd=b,Vd.contextDependencies={first:b,expirationTime:0}):Wd=Wd.next=b;}return Va?a._currentValue:a._currentValue2;}var Zd=0,qc=1,rc=2,$d=3,Od=!1;function ae(a){return{baseState:a,firstUpdate:null,lastUpdate:null,firstCapturedUpdate:null,lastCapturedUpdate:null,firstEffect:null,lastEffect:null,firstCapturedEffect:null,lastCapturedEffect:null};}function be(a){return{baseState:a.baseState,firstUpdate:a.firstUpdate,lastUpdate:a.lastUpdate,firstCapturedUpdate:null,lastCapturedUpdate:null,firstEffect:null,lastEffect:null,firstCapturedEffect:null,lastCapturedEffect:null};}function mc(a){return{expirationTime:a,tag:Zd,payload:null,callback:null,next:null,nextEffect:null};}function ce(a,b){null===a.lastUpdate?a.firstUpdate=a.lastUpdate=b:(a.lastUpdate.next=b,a.lastUpdate=b);}function oc(a,b){var c=a.alternate;if(null===c){var d=a.updateQueue;var e=null;null===d&&(d=a.updateQueue=ae(a.memoizedState));}else d=a.updateQueue,e=c.updateQueue,null===d?null===e?(d=a.updateQueue=ae(a.memoizedState),e=c.updateQueue=ae(c.memoizedState)):d=a.updateQueue=be(e):null===e&&(e=c.updateQueue=be(d));null===e||d===e?ce(d,b):null===d.lastUpdate||null===e.lastUpdate?(ce(d,b),ce(e,b)):(ce(d,b),e.lastUpdate=b);}function de(a,b){var c=a.updateQueue;c=null===c?a.updateQueue=ae(a.memoizedState):ee(a,c);null===c.lastCapturedUpdate?c.firstCapturedUpdate=c.lastCapturedUpdate=b:(c.lastCapturedUpdate.next=b,c.lastCapturedUpdate=b);}function ee(a,b){var c=a.alternate;null!==c&&b===c.updateQueue&&(b=a.updateQueue=be(b));return b;}function fe(a,b,c,d,e,f){switch(c.tag){case qc:return a=c.payload,"function"===typeof a?a.call(f,d,e):a;case $d:a.effectTag=a.effectTag&-2049|64;case Zd:a=c.payload;e="function"===typeof a?a.call(f,d,e):a;if(null===e||void 0===e)break;return aa({},d,e);case rc:Od=!0;}return d;}function xc(a,b,c,d,e){Od=!1;b=ee(a,b);for(var f=b.baseState,g=null,h=0,k=b.firstUpdate,l=f;null!==k;){var m=k.expirationTime;m<e?(null===g&&(g=k,f=l),h<m&&(h=m)):(l=fe(a,b,k,l,c,d),null!==k.callback&&(a.effectTag|=32,k.nextEffect=null,null===b.lastEffect?b.firstEffect=b.lastEffect=k:(b.lastEffect.nextEffect=k,b.lastEffect=k)));k=k.next;}m=null;for(k=b.firstCapturedUpdate;null!==k;){var v=k.expirationTime;v<e?(null===m&&(m=k,null===g&&(f=l)),h<v&&(h=v)):(l=fe(a,b,k,l,c,d),null!==k.callback&&(a.effectTag|=32,k.nextEffect=null,null===b.lastCapturedEffect?b.firstCapturedEffect=b.lastCapturedEffect=k:(b.lastCapturedEffect.nextEffect=k,b.lastCapturedEffect=k)));k=k.next;}null===g&&(b.lastUpdate=null);null===m?b.lastCapturedUpdate=null:a.effectTag|=32;null===g&&null===m&&(f=l);b.baseState=f;b.firstUpdate=g;b.firstCapturedUpdate=m;a.expirationTime=h;a.memoizedState=l;}function ge(a,b,c){null!==b.firstCapturedUpdate&&(null!==b.lastUpdate&&(b.lastUpdate.next=b.firstCapturedUpdate,b.lastUpdate=b.lastCapturedUpdate),b.firstCapturedUpdate=b.lastCapturedUpdate=null);he(b.firstEffect,c);b.firstEffect=b.lastEffect=null;he(b.firstCapturedEffect,c);b.firstCapturedEffect=b.lastCapturedEffect=null;}function he(a,b){for(;null!==a;){var c=a.callback;if(null!==c){a.callback=null;var d=b;"function"!==typeof c?p("191",c):void 0;c.call(d);}a=a.nextEffect;}}function ie(a,b){return{value:a,source:b,stack:Bb(b)};}function je(a){a.effectTag|=4;}var ke=void 0,le=void 0,me=void 0,ne=void 0;if(Wa)ke=function(a,b){for(var c=b.child;null!==c;){if(5===c.tag||6===c.tag)Ga(a,c.stateNode);else if(4!==c.tag&&null!==c.child){c.child.return=c;c=c.child;continue;}if(c===b)break;for(;null===c.sibling;){if(null===c.return||c.return===b)return;c=c.return;}c.sibling.return=c.return;c=c.sibling;}},le=function(){},me=function(a,b,c,d,e){a=a.memoizedProps;if(a!==d){var f=b.stateNode,g=Lc();c=Ia(f,c,a,d,e,g);(b.updateQueue=c)&&je(b);}},ne=function(a,b,c,d){c!==d&&je(b);};else if(Xa){ke=function(a,b,c,d){for(var e=b.child;null!==e;){a:if(5===e.tag){var f=e.stateNode;if(c){var g=e.memoizedProps,h=e.type;f=d?rb(f,h,g,e):sb(f,h,g,e);e.stateNode=f;}Ga(a,f);}else if(6===e.tag)f=e.stateNode,c&&(f=e.memoizedProps,g=Ic(Hc.current),h=Lc(),f=d?tb(f,g,h,b):La(f,g,h,b),e.stateNode=f),Ga(a,f);else if(4!==e.tag){if(13===e.tag&&(g=e.alternate,null!==g&&(f=null!==e.memoizedState,null!==g.memoizedState!==f))){g=f?e.child:e;null!==g&&ke(a,g,!0,f);break a;}if(null!==e.child){e.child.return=e;e=e.child;continue;}}if(e===b)break;for(;null===e.sibling;){if(null===e.return||e.return===b)return;e=e.return;}e.sibling.return=e.return;e=e.sibling;}};var oe=function(a,b,c,d){for(var e=b.child;null!==e;){a:if(5===e.tag){var f=e.stateNode;if(c){var g=e.memoizedProps,h=e.type;f=d?rb(f,h,g,e):sb(f,h,g,e);e.stateNode=f;}ob(a,f);}else if(6===e.tag)f=e.stateNode,c&&(f=e.memoizedProps,g=Ic(Hc.current),h=Lc(),f=d?tb(f,g,h,b):La(f,g,h,b),e.stateNode=f),ob(a,f);else if(4!==e.tag){if(13===e.tag&&(g=e.alternate,null!==g&&(f=null!==e.memoizedState,null!==g.memoizedState!==f))){g=f?e.child:e;null!==g&&oe(a,g,!0,f);break a;}if(null!==e.child){e.child.return=e;e=e.child;continue;}}if(e===b)break;for(;null===e.sibling;){if(null===e.return||e.return===b)return;e=e.return;}e.sibling.return=e.return;e=e.sibling;}};le=function(a){var b=a.stateNode;if(null!==a.firstEffect){var c=b.containerInfo,d=nb(c);oe(d,a,!1,!1);b.pendingChildren=d;je(a);pb(c,d);}};me=function(a,b,c,d,e){var f=a.stateNode,g=a.memoizedProps;if((a=null===b.firstEffect)&&g===d)b.stateNode=f;else{var h=b.stateNode,k=Lc(),l=null;g!==d&&(l=Ia(h,c,g,d,e,k));a&&null===l?b.stateNode=f:(f=mb(f,l,c,g,d,b,a,h),Ha(f,c,d,e,k)&&je(b),b.stateNode=f,a?je(b):ke(f,b,!1,!1));}};ne=function(a,b,c,d){c!==d&&(a=Ic(Hc.current),c=Lc(),b.stateNode=La(d,a,c,b),je(b));};}else le=function(){},me=function(){},ne=function(){};var pe="function"===typeof WeakSet?WeakSet:Set;function qe(a,b){var c=b.source,d=b.stack;null===d&&null!==c&&(d=Bb(c));null!==c&&ta(c.type);b=b.value;null!==a&&1===a.tag&&ta(a.type);try{console.error(b);}catch(e){setTimeout(function(){throw e;});}}function re(a){var b=a.ref;if(null!==b)if("function"===typeof b)try{b(null);}catch(c){se(a,c);}else b.current=null;}function te(a,b,c){c=c.updateQueue;c=null!==c?c.lastEffect:null;if(null!==c){var d=c=c.next;do{if((d.tag&a)!==Oc){var e=d.destroy;d.destroy=void 0;void 0!==e&&e();}(d.tag&b)!==Oc&&(e=d.create,d.destroy=e());d=d.next;}while(d!==c);}}function ue(a,b){if(Wa)for(var c=a;;){if(5===c.tag){var d=c.stateNode;b?ib(d):kb(c.stateNode,c.memoizedProps);}else if(6===c.tag)d=c.stateNode,b?jb(d):lb(d,c.memoizedProps);else if(13===c.tag&&null!==c.memoizedState){d=c.child.sibling;d.return=c;c=d;continue;}else if(null!==c.child){c.child.return=c;c=c.child;continue;}if(c===a)break;for(;null===c.sibling;){if(null===c.return||c.return===a)return;c=c.return;}c.sibling.return=c.return;c=c.sibling;}}function ve(a){"function"===typeof Ob&&Ob(a);switch(a.tag){case 0:case 11:case 14:case 15:var b=a.updateQueue;if(null!==b&&(b=b.lastEffect,null!==b)){var c=b=b.next;do{var d=c.destroy;if(void 0!==d){var e=a;try{d();}catch(f){se(e,f);}}c=c.next;}while(c!==b);}break;case 1:re(a);b=a.stateNode;if("function"===typeof b.componentWillUnmount)try{b.props=a.memoizedProps,b.state=a.memoizedState,b.componentWillUnmount();}catch(f){se(a,f);}break;case 5:re(a);break;case 4:Wa?we(a):Xa&&Xa&&(a=a.stateNode.containerInfo,b=nb(a),qb(a,b));}}function xe(a){for(var b=a;;)if(ve(b),null===b.child||Wa&&4===b.tag){if(b===a)break;for(;null===b.sibling;){if(null===b.return||b.return===a)return;b=b.return;}b.sibling.return=b.return;b=b.sibling;}else b.child.return=b,b=b.child;}function ye(a){if(Xa)switch(a.tag){case 1:break;case 5:break;case 6:break;case 3:case 4:a=a.stateNode;qb(a.containerInfo,a.pendingChildren);break;default:p("163");}}function ze(a){return 5===a.tag||3===a.tag||4===a.tag;}function Ae(a){if(Wa){a:{for(var b=a.return;null!==b;){if(ze(b)){var c=b;break a;}b=b.return;}p("160");c=void 0;}var d=b=void 0;switch(c.tag){case 5:b=c.stateNode;d=!1;break;case 3:b=c.stateNode.containerInfo;d=!0;break;case 4:b=c.stateNode.containerInfo;d=!0;break;default:p("161");}c.effectTag&16&&(hb(b),c.effectTag&=-17);a:b:for(c=a;;){for(;null===c.sibling;){if(null===c.return||ze(c.return)){c=null;break a;}c=c.return;}c.sibling.return=c.return;for(c=c.sibling;5!==c.tag&&6!==c.tag&&18!==c.tag;){if(c.effectTag&2)continue b;if(null===c.child||4===c.tag)continue b;else c.child.return=c,c=c.child;}if(!(c.effectTag&2)){c=c.stateNode;break a;}}for(var e=a;;){if(5===e.tag||6===e.tag)c?d?eb(b,e.stateNode,c):db(b,e.stateNode,c):d?$a(b,e.stateNode):Za(b,e.stateNode);else if(4!==e.tag&&null!==e.child){e.child.return=e;e=e.child;continue;}if(e===a)break;for(;null===e.sibling;){if(null===e.return||e.return===a)return;e=e.return;}e.sibling.return=e.return;e=e.sibling;}}}function we(a){for(var b=a,c=!1,d=void 0,e=void 0;;){if(!c){c=b.return;a:for(;;){null===c?p("160"):void 0;switch(c.tag){case 5:d=c.stateNode;e=!1;break a;case 3:d=c.stateNode.containerInfo;e=!0;break a;case 4:d=c.stateNode.containerInfo;e=!0;break a;}c=c.return;}c=!0;}if(5===b.tag||6===b.tag)xe(b),e?gb(d,b.stateNode):fb(d,b.stateNode);else if(4===b.tag){if(null!==b.child){d=b.stateNode.containerInfo;e=!0;b.child.return=b;b=b.child;continue;}}else if(ve(b),null!==b.child){b.child.return=b;b=b.child;continue;}if(b===a)break;for(;null===b.sibling;){if(null===b.return||b.return===a)return;b=b.return;4===b.tag&&(c=!1);}b.sibling.return=b.return;b=b.sibling;}}function Be(a,b){if(Wa)switch(b.tag){case 0:case 11:case 14:case 15:te(Qc,Rc,b);break;case 1:break;case 5:var c=b.stateNode;if(null!=c){var d=b.memoizedProps;a=null!==a?a.memoizedProps:d;var e=b.type,f=b.updateQueue;b.updateQueue=null;null!==f&&cb(c,f,e,a,d,b);}break;case 6:null===b.stateNode?p("162"):void 0;c=b.memoizedProps;ab(b.stateNode,null!==a?a.memoizedProps:c,c);break;case 3:break;case 12:break;case 13:c=b.memoizedState;d=void 0;a=b;null===c?d=!1:(d=!0,a=b.child,0===c.timedOutAt&&(c.timedOutAt=kc()));null!==a&&ue(a,d);c=b.updateQueue;if(null!==c){b.updateQueue=null;var g=b.stateNode;null===g&&(g=b.stateNode=new pe());c.forEach(function(a){var c=Ce.bind(null,b,a);g.has(a)||(g.add(a),a.then(c,c));});}break;case 17:break;default:p("163");}else{switch(b.tag){case 0:case 11:case 14:case 15:te(Qc,Rc,b);return;}ye(b);}}var De="function"===typeof WeakMap?WeakMap:Map;function Ee(a,b,c){c=mc(c);c.tag=$d;c.payload={element:null};var d=b.value;c.callback=function(){Fe(d);qe(a,b);};return c;}function Ge(a,b,c){c=mc(c);c.tag=$d;var d=a.type.getDerivedStateFromError;if("function"===typeof d){var e=b.value;c.payload=function(){return d(e);};}var f=a.stateNode;null!==f&&"function"===typeof f.componentDidCatch&&(c.callback=function(){"function"!==typeof d&&(null===He?He=new Set([this]):He.add(this));var c=b.value,e=b.stack;qe(a,b);this.componentDidCatch(c,{componentStack:null!==e?e:""});});return c;}function Ie(a){switch(a.tag){case 1:E(a.type)&&Hb();var b=a.effectTag;return b&2048?(a.effectTag=b&-2049|64,a):null;case 3:return Kc(),Ib(),b=a.effectTag,0!==(b&64)?p("285"):void 0,a.effectTag=b&-2049|64,a;case 5:return Nc(a),null;case 13:return b=a.effectTag,b&2048?(a.effectTag=b&-2049|64,a):null;case 18:return null;case 4:return Kc(),null;case 10:return Yd(a),null;default:return null;}}var Je=da.ReactCurrentDispatcher,Ke=da.ReactCurrentOwner,Le=1073741822,Me=!1,O=null,P=null,Q=0,Ne=-1,Oe=!1,R=null,Pe=!1,Qe=null,Re=null,Se=null,He=null;function Te(){if(null!==O)for(var a=O.return;null!==a;){var b=a;switch(b.tag){case 1:var c=b.type.childContextTypes;null!==c&&void 0!==c&&Hb();break;case 3:Kc();Ib();break;case 5:Nc(b);break;case 4:Kc();break;case 10:Yd(b);}a=a.return;}P=null;Q=0;Ne=-1;Oe=!1;O=null;}function Ue(){for(;null!==R;){var a=R.effectTag;a&16&&Wa&&hb(R.stateNode);if(a&128){var b=R.alternate;null!==b&&(b=b.ref,null!==b&&("function"===typeof b?b(null):b.current=null));}switch(a&14){case 2:Ae(R);R.effectTag&=-3;break;case 6:Ae(R);R.effectTag&=-3;Be(R.alternate,R);break;case 4:Be(R.alternate,R);break;case 8:a=R,Wa?we(a):xe(a),a.return=null,a.child=null,a.memoizedState=null,a.updateQueue=null,a=a.alternate,null!==a&&(a.return=null,a.child=null,a.memoizedState=null,a.updateQueue=null);}R=R.nextEffect;}}function Ve(){for(;null!==R;){if(R.effectTag&256)a:{var a=R.alternate,b=R;switch(b.tag){case 0:case 11:case 15:te(Pc,Oc,b);break a;case 1:if(b.effectTag&256&&null!==a){var c=a.memoizedProps,d=a.memoizedState;a=b.stateNode;b=a.getSnapshotBeforeUpdate(b.elementType===b.type?c:G(b.type,c),d);a.__reactInternalSnapshotBeforeUpdate=b;}break a;case 3:case 5:case 6:case 4:case 17:break a;default:p("163");}}R=R.nextEffect;}}function We(a,b){for(;null!==R;){var c=R.effectTag;if(c&36){var d=R.alternate,e=R,f=b;switch(e.tag){case 0:case 11:case 15:te(Sc,Tc,e);break;case 1:var g=e.stateNode;if(e.effectTag&4)if(null===d)g.componentDidMount();else{var h=e.elementType===e.type?d.memoizedProps:G(e.type,d.memoizedProps);g.componentDidUpdate(h,d.memoizedState,g.__reactInternalSnapshotBeforeUpdate);}d=e.updateQueue;null!==d&&ge(e,d,g);break;case 3:d=e.updateQueue;if(null!==d){g=null;if(null!==e.child)switch(e.child.tag){case 5:g=za(e.child.stateNode);break;case 1:g=e.child.stateNode;}ge(e,d,g);}break;case 5:f=e.stateNode;null===d&&e.effectTag&4&&bb(f,e.type,e.memoizedProps,e);break;case 6:break;case 4:break;case 12:break;case 13:break;case 17:break;default:p("163");}}if(c&128&&(e=R.ref,null!==e)){f=R.stateNode;switch(R.tag){case 5:f=za(f);}"function"===typeof e?e(f):e.current=f;}c&512&&(Qe=a);R=R.nextEffect;}}function Xe(a,b){Se=Re=Qe=null;var c=S;S=!0;do{if(b.effectTag&512){var d=!1,e=void 0;try{var f=b;te(Vc,Oc,f);te(Oc,Uc,f);}catch(g){d=!0,e=g;}d&&se(b,e);}b=b.nextEffect;}while(null!==b);S=c;c=a.expirationTime;0!==c&&Ye(a,c);T||S||U(1073741823,!1);}function nc(){null!==Re&&Ta(Re);null!==Se&&Se();}function Ze(a,b){Pe=Me=!0;a.current===b?p("177"):void 0;var c=a.pendingCommitExpirationTime;0===c?p("261"):void 0;a.pendingCommitExpirationTime=0;var d=b.expirationTime,e=b.childExpirationTime;bc(a,e>d?e:d);Ke.current=null;d=void 0;1<b.effectTag?null!==b.lastEffect?(b.lastEffect.nextEffect=b,d=b.firstEffect):d=b:d=b.firstEffect;Da(a.containerInfo);for(R=d;null!==R;){e=!1;var f=void 0;try{Ve();}catch(h){e=!0,f=h;}e&&(null===R?p("178"):void 0,se(R,f),null!==R&&(R=R.nextEffect));}for(R=d;null!==R;){e=!1;f=void 0;try{Ue();}catch(h){e=!0,f=h;}e&&(null===R?p("178"):void 0,se(R,f),null!==R&&(R=R.nextEffect));}Ea(a.containerInfo);a.current=b;for(R=d;null!==R;){e=!1;f=void 0;try{We(a,c);}catch(h){e=!0,f=h;}e&&(null===R?p("178"):void 0,se(R,f),null!==R&&(R=R.nextEffect));}if(null!==d&&null!==Qe){var g=Xe.bind(null,a,d);Re=n.unstable_runWithPriority(n.unstable_NormalPriority,function(){return Sa(g);});Se=g;}Me=Pe=!1;"function"===typeof Nb&&Nb(b.stateNode);c=b.expirationTime;b=b.childExpirationTime;b=b>c?b:c;0===b&&(He=null);$e(a,b);}function af(a){for(;;){var b=a.alternate,c=a.return,d=a.sibling;if(0===(a.effectTag&1024)){O=a;a:{var e=b;b=a;var f=Q,g=b.pendingProps;switch(b.tag){case 2:break;case 16:break;case 15:case 0:break;case 1:E(b.type)&&Hb();break;case 3:Kc();Ib();g=b.stateNode;g.pendingContext&&(g.context=g.pendingContext,g.pendingContext=null);if(null===e||null===e.child)Dd(b),b.effectTag&=-3;le(b);break;case 5:Nc(b);f=Ic(Hc.current);var h=b.type;if(null!==e&&null!=b.stateNode)me(e,b,h,g,f),e.ref!==b.ref&&(b.effectTag|=128);else if(g){e=Lc();if(Dd(b))g=b,Ya||p("175"),e=yb(g.stateNode,g.type,g.memoizedProps,f,e,g),g.updateQueue=e,e=null!==e?!0:!1,e&&je(b);else{var k=Fa(h,g,f,e,b);ke(k,b,!1,!1);Ha(k,h,g,f,e)&&je(b);b.stateNode=k;}null!==b.ref&&(b.effectTag|=128);}else null===b.stateNode?p("166"):void 0;break;case 6:e&&null!=b.stateNode?ne(e,b,e.memoizedProps,g):("string"!==typeof g&&(null===b.stateNode?p("166"):void 0),e=Ic(Hc.current),f=Lc(),Dd(b)?(e=b,Ya||p("176"),(e=zb(e.stateNode,e.memoizedProps,e))&&je(b)):b.stateNode=La(g,e,f,b));break;case 11:break;case 13:g=b.memoizedState;if(0!==(b.effectTag&64)){b.expirationTime=f;O=b;break a;}g=null!==g;f=null!==e&&null!==e.memoizedState;null!==e&&!g&&f&&(e=e.child.sibling,null!==e&&(h=b.firstEffect,null!==h?(b.firstEffect=e,e.nextEffect=h):(b.firstEffect=b.lastEffect=e,e.nextEffect=null),e.effectTag=8));if(g||f)b.effectTag|=4;break;case 7:break;case 8:break;case 12:break;case 4:Kc();le(b);break;case 10:Yd(b);break;case 9:break;case 14:break;case 17:E(b.type)&&Hb();break;case 18:break;default:p("156");}O=null;}b=a;if(1===Q||1!==b.childExpirationTime){e=0;for(g=b.child;null!==g;)f=g.expirationTime,h=g.childExpirationTime,f>e&&(e=f),h>e&&(e=h),g=g.sibling;b.childExpirationTime=e;}if(null!==O)return O;null!==c&&0===(c.effectTag&1024)&&(null===c.firstEffect&&(c.firstEffect=a.firstEffect),null!==a.lastEffect&&(null!==c.lastEffect&&(c.lastEffect.nextEffect=a.firstEffect),c.lastEffect=a.lastEffect),1<a.effectTag&&(null!==c.lastEffect?c.lastEffect.nextEffect=a:c.firstEffect=a,c.lastEffect=a));}else{a=Ie(a);if(null!==a)return a.effectTag&=1023,a;null!==c&&(c.firstEffect=c.lastEffect=null,c.effectTag|=1024);}if(null!==d)return d;if(null!==c)a=c;else break;}return null;}function bf(a){var b=Sd(a.alternate,a,Q);a.memoizedProps=a.pendingProps;null===b&&(b=af(a));Ke.current=null;return b;}function cf(a,b){Me?p("243"):void 0;nc();Me=!0;var c=Je.current;Je.current=jd;var d=a.nextExpirationTimeToWorkOn;if(d!==Q||a!==P||null===O)Te(),P=a,Q=d,O=Ub(P.current,null),a.pendingCommitExpirationTime=0;var e=!1;do{try{if(b)for(;null!==O&&!df();)O=bf(O);else for(;null!==O;)O=bf(O);}catch(q){if(Xd=Wd=Vd=null,kd(),null===O)e=!0,Fe(q);else{null===O?p("271"):void 0;var f=O,g=f.return;if(null===g)e=!0,Fe(q);else{a:{var h=a,k=g,l=f,m=q;g=Q;l.effectTag|=1024;l.firstEffect=l.lastEffect=null;if(null!==m&&"object"===typeof m&&"function"===typeof m.then){var v=m;m=k;var w=-1,D=-1;do{if(13===m.tag){var t=m.alternate;if(null!==t&&(t=t.memoizedState,null!==t)){D=10*(1073741822-t.timedOutAt);break;}t=m.pendingProps.maxDuration;if("number"===typeof t)if(0>=t)w=0;else if(-1===w||t<w)w=t;}m=m.return;}while(null!==m);m=k;do{if(t=13===m.tag)t=void 0===m.memoizedProps.fallback?!1:null===m.memoizedState;if(t){k=m.updateQueue;null===k?(k=new Set(),k.add(v),m.updateQueue=k):k.add(v);if(0===(m.mode&1)){m.effectTag|=64;l.effectTag&=-1957;1===l.tag&&(null===l.alternate?l.tag=17:(g=mc(1073741823),g.tag=rc,oc(l,g)));l.expirationTime=1073741823;break a;}l=h;k=g;var Ba=l.pingCache;null===Ba?(Ba=l.pingCache=new De(),t=new Set(),Ba.set(v,t)):(t=Ba.get(v),void 0===t&&(t=new Set(),Ba.set(v,t)));t.has(k)||(t.add(k),l=ef.bind(null,l,v,k),v.then(l,l));-1===w?h=1073741823:(-1===D&&(D=10*(1073741822-dc(h,g))-5E3),h=D+w);0<=h&&Ne<h&&(Ne=h);m.effectTag|=2048;m.expirationTime=g;break a;}m=m.return;}while(null!==m);m=Error((ta(l.type)||"A React component")+" suspended while rendering, but no fallback UI was specified.\n\nAdd a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display."+Bb(l));}Oe=!0;m=ie(m,l);h=k;do{switch(h.tag){case 3:h.effectTag|=2048;h.expirationTime=g;g=Ee(h,m,g);de(h,g);break a;case 1:if(w=m,D=h.type,l=h.stateNode,0===(h.effectTag&64)&&("function"===typeof D.getDerivedStateFromError||null!==l&&"function"===typeof l.componentDidCatch&&(null===He||!He.has(l)))){h.effectTag|=2048;h.expirationTime=g;g=Ge(h,w,g);de(h,g);break a;}}h=h.return;}while(null!==h);}O=af(f);continue;}}}break;}while(1);Me=!1;Je.current=c;Xd=Wd=Vd=null;kd();if(e)P=null,a.finishedWork=null;else if(null!==O)a.finishedWork=null;else{c=a.current.alternate;null===c?p("281"):void 0;P=null;if(Oe){e=a.latestPendingTime;f=a.latestSuspendedTime;g=a.latestPingedTime;if(0!==e&&e<d||0!==f&&f<d||0!==g&&g<d){cc(a,d);ff(a,c,d,a.expirationTime,-1);return;}if(!a.didError&&b){a.didError=!0;d=a.nextExpirationTimeToWorkOn=d;b=a.expirationTime=1073741823;ff(a,c,d,b,-1);return;}}b&&-1!==Ne?(cc(a,d),b=10*(1073741822-dc(a,d)),b<Ne&&(Ne=b),b=10*(1073741822-kc()),b=Ne-b,ff(a,c,d,a.expirationTime,0>b?0:b)):(a.pendingCommitExpirationTime=d,a.finishedWork=c);}}function se(a,b){for(var c=a.return;null!==c;){switch(c.tag){case 1:var d=c.stateNode;if("function"===typeof c.type.getDerivedStateFromError||"function"===typeof d.componentDidCatch&&(null===He||!He.has(d))){a=ie(b,a);a=Ge(c,a,1073741823);oc(c,a);pc(c,1073741823);return;}break;case 3:a=ie(b,a);a=Ee(c,a,1073741823);oc(c,a);pc(c,1073741823);return;}c=c.return;}3===a.tag&&(c=ie(b,a),c=Ee(a,c,1073741823),oc(a,c),pc(a,1073741823));}function lc(a,b){var c=n.unstable_getCurrentPriorityLevel(),d=void 0;if(0===(b.mode&1))d=1073741823;else if(Me&&!Pe)d=Q;else{switch(c){case n.unstable_ImmediatePriority:d=1073741823;break;case n.unstable_UserBlockingPriority:d=1073741822-10*(((1073741822-a+15)/10|0)+1);break;case n.unstable_NormalPriority:d=1073741822-25*(((1073741822-a+500)/25|0)+1);break;case n.unstable_LowPriority:case n.unstable_IdlePriority:d=1;break;default:p("313");}null!==P&&d===Q&&--d;}c===n.unstable_UserBlockingPriority&&(0===gf||d<gf)&&(gf=d);return d;}function ef(a,b,c){var d=a.pingCache;null!==d&&d.delete(b);if(null!==P&&Q===c)P=null;else if(b=a.earliestSuspendedTime,d=a.latestSuspendedTime,0!==b&&c<=b&&c>=d){a.didError=!1;b=a.latestPingedTime;if(0===b||b>c)a.latestPingedTime=c;ac(c,a);c=a.expirationTime;0!==c&&Ye(a,c);}}function Ce(a,b){var c=a.stateNode;null!==c&&c.delete(b);b=kc();b=lc(b,a);a=hf(a,b);null!==a&&($b(a,b),b=a.expirationTime,0!==b&&Ye(a,b));}function hf(a,b){a.expirationTime<b&&(a.expirationTime=b);var c=a.alternate;null!==c&&c.expirationTime<b&&(c.expirationTime=b);var d=a.return,e=null;if(null===d&&3===a.tag)e=a.stateNode;else for(;null!==d;){c=d.alternate;d.childExpirationTime<b&&(d.childExpirationTime=b);null!==c&&c.childExpirationTime<b&&(c.childExpirationTime=b);if(null===d.return&&3===d.tag){e=d.stateNode;break;}d=d.return;}return e;}function pc(a,b){a=hf(a,b);null!==a&&(!Me&&0!==Q&&b>Q&&Te(),$b(a,b),Me&&!Pe&&P===a||Ye(a,a.expirationTime),jf>kf&&(jf=0,p("185")));}function lf(a,b,c,d,e){return n.unstable_runWithPriority(n.unstable_ImmediatePriority,function(){return a(b,c,d,e);});}var V=null,W=null,mf=0,nf=void 0,S=!1,X=null,Y=0,gf=0,of=!1,pf=null,T=!1,qf=!1,rf=null,sf=Ua(),Z=1073741822-(sf/10|0),tf=Z,kf=50,jf=0,uf=null;function vf(){Z=1073741822-((Ua()-sf)/10|0);}function wf(a,b){if(0!==mf){if(b<mf)return;null!==nf&&Na(nf);}mf=b;a=Ua()-sf;nf=Ma(xf,{timeout:10*(1073741822-b)-a});}function ff(a,b,c,d,e){a.expirationTime=d;0!==e||df()?0<e&&(a.timeoutHandle=Pa(yf.bind(null,a,b,c),e)):(a.pendingCommitExpirationTime=c,a.finishedWork=b);}function yf(a,b,c){a.pendingCommitExpirationTime=c;a.finishedWork=b;vf();tf=Z;zf(a,c);}function $e(a,b){a.expirationTime=b;a.finishedWork=null;}function kc(){if(S)return tf;Af();if(0===Y||1===Y)vf(),tf=Z;return tf;}function Ye(a,b){null===a.nextScheduledRoot?(a.expirationTime=b,null===W?(V=W=a,a.nextScheduledRoot=a):(W=W.nextScheduledRoot=a,W.nextScheduledRoot=V)):b>a.expirationTime&&(a.expirationTime=b);S||(T?qf&&(X=a,Y=1073741823,Bf(a,1073741823,!1)):1073741823===b?U(1073741823,!1):wf(a,b));}function Af(){var a=0,b=null;if(null!==W)for(var c=W,d=V;null!==d;){var e=d.expirationTime;if(0===e){null===c||null===W?p("244"):void 0;if(d===d.nextScheduledRoot){V=W=d.nextScheduledRoot=null;break;}else if(d===V)V=e=d.nextScheduledRoot,W.nextScheduledRoot=e,d.nextScheduledRoot=null;else if(d===W){W=c;W.nextScheduledRoot=V;d.nextScheduledRoot=null;break;}else c.nextScheduledRoot=d.nextScheduledRoot,d.nextScheduledRoot=null;d=c.nextScheduledRoot;}else{e>a&&(a=e,b=d);if(d===W)break;if(1073741823===a)break;c=d;d=d.nextScheduledRoot;}}X=b;Y=a;}var Cf=!1;function df(){return Cf?!0:Oa()?Cf=!0:!1;}function xf(){try{if(!df()&&null!==V){vf();var a=V;do{var b=a.expirationTime;0!==b&&Z<=b&&(a.nextExpirationTimeToWorkOn=Z);a=a.nextScheduledRoot;}while(a!==V);}U(0,!0);}finally{Cf=!1;}}function U(a,b){Af();if(b)for(vf(),tf=Z;null!==X&&0!==Y&&a<=Y&&!(Cf&&Z>Y);)Bf(X,Y,Z>Y),Af(),vf(),tf=Z;else for(;null!==X&&0!==Y&&a<=Y;)Bf(X,Y,!1),Af();b&&(mf=0,nf=null);0!==Y&&wf(X,Y);jf=0;uf=null;if(null!==rf)for(a=rf,rf=null,b=0;b<a.length;b++){var c=a[b];try{c._onComplete();}catch(d){of||(of=!0,pf=d);}}if(of)throw a=pf,pf=null,of=!1,a;}function zf(a,b){S?p("253"):void 0;X=a;Y=b;Bf(a,b,!1);U(1073741823,!1);}function Bf(a,b,c){S?p("245"):void 0;S=!0;if(c){var d=a.finishedWork;null!==d?Df(a,d,b):(a.finishedWork=null,d=a.timeoutHandle,d!==Ra&&(a.timeoutHandle=Ra,Qa(d)),cf(a,c),d=a.finishedWork,null!==d&&(df()?a.finishedWork=d:Df(a,d,b)));}else d=a.finishedWork,null!==d?Df(a,d,b):(a.finishedWork=null,d=a.timeoutHandle,d!==Ra&&(a.timeoutHandle=Ra,Qa(d)),cf(a,c),d=a.finishedWork,null!==d&&Df(a,d,b));S=!1;}function Df(a,b,c){var d=a.firstBatch;if(null!==d&&d._expirationTime>=c&&(null===rf?rf=[d]:rf.push(d),d._defer)){a.finishedWork=b;a.expirationTime=0;return;}a.finishedWork=null;a===uf?jf++:(uf=a,jf=0);n.unstable_runWithPriority(n.unstable_ImmediatePriority,function(){Ze(a,b);});}function Fe(a){null===X?p("246"):void 0;X.expirationTime=0;of||(of=!0,pf=a);}function Ef(a,b,c,d,e){var f=b.current;a:if(c){c=c._reactInternalFiber;b:{2===ua(c)&&1===c.tag?void 0:p("170");var g=c;do{switch(g.tag){case 3:g=g.stateNode.context;break b;case 1:if(E(g.type)){g=g.stateNode.__reactInternalMemoizedMergedChildContext;break b;}}g=g.return;}while(null!==g);p("171");g=void 0;}if(1===c.tag){var h=c.type;if(E(h)){c=Kb(c,h,g);break a;}}c=g;}else c=Eb;null===b.context?b.context=c:b.pendingContext=c;b=e;e=mc(d);e.payload={element:a};b=void 0===b?null:b;null!==b&&(e.callback=b);nc();oc(f,e);pc(f,d);return d;}function Ff(a){var b=a._reactInternalFiber;void 0===b&&("function"===typeof a.render?p("188"):p("268",Object.keys(a)));a=xa(b);return null===a?null:a.stateNode;}var Gf={updateContainerAtExpirationTime:Ef,createContainer:function(a,b,c){b=F(3,null,null,b?3:0);a={current:b,containerInfo:a,pendingChildren:null,pingCache:null,earliestPendingTime:0,latestPendingTime:0,earliestSuspendedTime:0,latestSuspendedTime:0,latestPingedTime:0,didError:!1,pendingCommitExpirationTime:0,finishedWork:null,timeoutHandle:Ra,context:null,pendingContext:null,hydrate:c,nextExpirationTimeToWorkOn:0,expirationTime:0,firstBatch:null,nextScheduledRoot:null};return b.stateNode=a;},updateContainer:function(a,b,c,d){var e=b.current,f=kc();e=lc(f,e);return Ef(a,b,c,e,d);},flushRoot:zf,requestWork:Ye,computeUniqueAsyncExpiration:function(){var a=1073741822-25*(((1073741822-kc()+500)/25|0)+1);a>=Le&&(a=Le-1);return Le=a;},batchedUpdates:function(a,b){var c=T;T=!0;try{return a(b);}finally{(T=c)||S||U(1073741823,!1);}},unbatchedUpdates:function(a,b){if(T&&!qf){qf=!0;try{return a(b);}finally{qf=!1;}}return a(b);},deferredUpdates:n.unstable_next,syncUpdates:lf,interactiveUpdates:function(a,b,c){T||S||0===gf||(U(gf,!1),gf=0);var d=T;T=!0;try{return n.unstable_runWithPriority(n.unstable_UserBlockingPriority,function(){return a(b,c);});}finally{(T=d)||S||U(1073741823,!1);}},flushInteractiveUpdates:function(){S||0===gf||(U(gf,!1),gf=0);},flushControlled:function(a){var b=T;T=!0;try{lf(a);}finally{(T=b)||S||U(1073741823,!1);}},flushSync:function(a,b){S?p("187"):void 0;var c=T;T=!0;try{return lf(a,b);}finally{T=c,U(1073741823,!1);}},getPublicRootInstance:function(a){a=a.current;if(!a.child)return null;switch(a.child.tag){case 5:return za(a.child.stateNode);default:return a.child.stateNode;}},findHostInstance:Ff,findHostInstanceWithWarning:function(a){return Ff(a);},findHostInstanceWithNoPortals:function(a){a=ya(a);return null===a?null:a.stateNode;},injectIntoDevTools:function(a){var b=a.findFiberByHostInstance;return Qb(aa({},a,{overrideProps:null,currentDispatcherRef:da.ReactCurrentDispatcher,findHostInstanceByFiber:function(a){a=xa(a);return null===a?null:a.stateNode;},findFiberByHostInstance:function(a){return b?b(a):null;}}));}};module.exports=Gf.default||Gf;var $$$renderer=module.exports;module.exports=$$$reconciler;return $$$renderer;};});/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ReactPropTypesSecret='SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED';var ReactPropTypesSecret_1=ReactPropTypesSecret;var printWarning=function(){};if(true){var ReactPropTypesSecret$1=ReactPropTypesSecret_1;var loggedTypeFailures={};var has=Function.call.bind(Object.prototype.hasOwnProperty);printWarning=function(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
 ...
 *
 * @private
 */checkPropTypes.resetWarningCache=function(){if(true){loggedTypeFailures={};}};var checkPropTypes_1=checkPropTypes;var schedulerTracing_production_min=createCommonjsModule(function(module,exports){Object.defineProperty(exports,"__esModule",{value:!0});var b=0;exports.__interactionsRef=null;exports.__subscriberRef=null;exports.unstable_clear=function(a){return a();};exports.unstable_getCurrent=function(){return null;};exports.unstable_getThreadID=function(){return++b;};exports.unstable_trace=function(a,d,c){return c();};exports.unstable_wrap=function(a){return a;};exports.unstable_subscribe=function(){};exports.unstable_unsubscribe=function(){};});unwrapExports(schedulerTracing_production_min);var schedulerTracing_production_min_1=schedulerTracing_production_min.__interactionsRef;var schedulerTracing_production_min_2=schedulerTracing_production_min.__subscriberRef;var schedulerTracing_production_min_3=schedulerTracing_production_min.unstable_clear;var schedulerTracing_production_min_4=schedulerTracing_production_min.unstable_getCurrent;var schedulerTracing_production_min_5=schedulerTracing_production_min.unstable_getThreadID;var schedulerTracing_production_min_6=schedulerTracing_production_min.unstable_trace;var schedulerTracing_production_min_7=schedulerTracing_production_min.unstable_wrap;var schedulerTracing_production_min_8=schedulerTracing_production_min.unstable_subscribe;var schedulerTracing_production_min_9=schedulerTracing_production_min.unstable_unsubscribe;var schedulerTracing_development=createCommonjsModule(function(module,exports){if(true){(function(){Object.defineProperty(exports,'__esModule',{value:true});// Only used in www builds.
 ...
 */function get(key){return key._reactInternalFiber;}function set(key,value){key._reactInternalFiber=value;}var ReactSharedInternals=React$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// Prevent newer renderers from RTE when used with older react package versions.
// Current owner and dispatcher used to share the same ref,
// but PR #14548 split them out to better support the react-debug-tools package.
if(!ReactSharedInternals.hasOwnProperty('ReactCurrentDispatcher')){ReactSharedInternals.ReactCurrentDispatcher={current:null};}// The Symbol used to tag the ReactElement-like types. If there is no native Symbol
...
return getStackByFiberInDevAndProd(current);}return'';}function resetCurrentFiber(){{ReactDebugCurrentFrame.getCurrentStack=null;current=null;phase=null;}}function setCurrentFiber(fiber){{ReactDebugCurrentFrame.getCurrentStack=getCurrentFiberStackInDev;current=fiber;phase=null;}}function setCurrentPhase(lifeCyclePhase){{phase=lifeCyclePhase;}}// Only used in www builds.
// Only used in www builds.
// React Fire: prevent the value and checked attributes from syncing
// with their related DOM properties
// These APIs will no longer be "unstable" in the upcoming 16.7 release,
...
return root;}var invokeGuardedCallbackImpl=function(name,func,context,a,b,c,d,e,f){var funcArgs=Array.prototype.slice.call(arguments,3);try{func.apply(context,funcArgs);}catch(error){this.onError(error);}};{// In DEV mode, we swap out invokeGuardedCallback for a special version
...
var hasError=false;var caughtError=null;var reporter={onError:function(error){hasError=true;caughtError=error;}};/**
 ...
 */function hasCaughtError(){return hasError;}function clearCaughtError(){if(hasError){var error=caughtError;hasError=false;caughtError=null;return error;}else{invariant(false,'clearCaughtError was called but no error was captured. This error is likely caused by a bug in React. Please file an issue.');}}/**
...
expirationTime=earliestSuspendedTime;}root.nextExpirationTimeToWorkOn=nextExpirationTimeToWorkOn;root.expirationTime=expirationTime;}/**
 * Similar to invariant but only logs a warning if the condition is not met.
 * This can be used to log issues in development environments in critical
 * paths. Removing the logging code for production environments will keep the
 * same logic and follow the same code paths.
...
for(var _len=arguments.length,args=Array(_len>2?_len-2:0),_key=2;_key<_len;_key++){args[_key-2]=arguments[_key];}warningWithoutStack$1.apply(undefined,[false,format+'%s'].concat(args,[stack]));};}var warning$1=warning;/**
...
for(var i=0;i<keysA.length;i++){if(!hasOwnProperty.call(objB,keysA[i])||!is(objA[keysA[i]],objB[keysA[i]])){return false;}}return true;}function resolveDefaultProps(Component,baseProps){if(Component&&Component.defaultProps){// Resolve default props. Taken from ReactElement
...
var emptyRefsObject=new React$1.Component().refs;var didWarnAboutStateAssignmentForComponent=void 0;var didWarnAboutUninitializedState=void 0;var didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate=void 0;var didWarnAboutLegacyLifecyclesAndDerivedState=void 0;var didWarnAboutUndefinedDerivedState=void 0;var warnOnUndefinedDerivedState=void 0;var warnOnInvalidCallback=void 0;var didWarnAboutDirectlyAssigningPropsToState=void 0;var didWarnAboutContextTypeAndContextTypes=void 0;var didWarnAboutInvalidateContextType=void 0;{didWarnAboutStateAssignmentForComponent=new Set();didWarnAboutUninitializedState=new Set();didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate=new Set();didWarnAboutLegacyLifecyclesAndDerivedState=new Set();didWarnAboutDirectlyAssigningPropsToState=new Set();didWarnAboutUndefinedDerivedState=new Set();didWarnAboutContextTypeAndContextTypes=new Set();didWarnAboutInvalidateContextType=new Set();var didWarnOnInvalidCallback=new Set();warnOnInvalidCallback=function(callback,callerName){if(callback===null||typeof callback==='function'){return;}var key=callerName+'_'+callback;if(!didWarnOnInvalidCallback.has(key)){didWarnOnInvalidCallback.add(key);warningWithoutStack$1(false,'%s(...): Expected the last optional `callback` argument to be a '+'function. Instead received: %s.',callerName,callback);}};warnOnUndefinedDerivedState=function(type,partialState){if(partialState===undefined){var componentName=getComponentName(type)||'Component';if(!didWarnAboutUndefinedDerivedState.has(componentName)){didWarnAboutUndefinedDerivedState.add(componentName);warningWithoutStack$1(false,'%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. '+'You have returned undefined.',componentName);}}};// This is so gross but it's at least non-critical and can be removed if
...
var _nextFallbackChildren=nextProps.fallback;var _primaryChildFragment=createWorkInProgress(currentPrimaryChildFragment,currentPrimaryChildFragment.pendingProps);if((workInProgress.mode&ConcurrentMode)===NoContext){// Outside of concurrent mode, we commit the effects from the
...
workInProgress.contextDependencies=current$$1.contextDependencies;}{// Don't update "base" render times for bailouts.
...
return child.sibling;}else{return null;}}}break;}case DehydratedSuspenseComponent:}return bailoutOnAlreadyFinishedWork(current$$1,workInProgress,renderExpirationTime);}}else{didReceiveUpdate=false;}// Before entering the begin phase, clear the expiration time.
...
var _Component=workInProgress.type;if(isContextProvider(_Component)){popContext(workInProgress);}break;}case DehydratedSuspenseComponent:{break;}default:invariant(false,'Unknown unit of work tag. This error is likely caused by a bug in React. Please file an issue.');}return null;}function shouldCaptureSuspense(workInProgress){// In order to capture, the Suspense component must have a fallback prop.
...
var nextState=workInProgress.memoizedState;return nextState===null;}function logCapturedError(capturedError){var error=capturedError.error;{var componentName=capturedError.componentName,componentStack=capturedError.componentStack,errorBoundaryName=capturedError.errorBoundaryName,errorBoundaryFound=capturedError.errorBoundaryFound,willRetry=capturedError.willRetry;// Browsers support silencing uncaught errors by calling
...
return;}case Profiler:{{var onRender=finishedWork.memoizedProps.onRender;{onRender(finishedWork.memoizedProps.id,current$$1===null?'mount':'update',finishedWork.actualDuration,finishedWork.treeBaseDuration,finishedWork.actualStartTime,getCommitTime(),finishedRoot.memoizedInteractions);}}return;}case SuspenseComponent:break;case IncompleteClassComponent:break;default:{invariant(false,'This unit of work tag should not have side-effects. This error is likely caused by a bug in React. Please file an issue.');}}}function hideOrUnhideAllChildren(finishedWork,isHidden){if(supportsMutation){// We only have the top Fiber that was inserted but we need to recurse down its
...
// whole tree.
renderDidSuspend(root,absoluteTimeoutMs);_workInProgress.effectTag|=ShouldCapture;_workInProgress.expirationTime=renderExpirationTime;return;}// This boundary already captured during this render. Continue to the next
// boundary.
...
var next=unwindWork(workInProgress);// Because this fiber did not complete, don't reset its expiration time.
if(workInProgress.effectTag&DidCapture){// Restarting an error boundary
stopFailedWorkTimer(workInProgress);}else{stopWorkTimer(workInProgress);}{resetCurrentFiber();}if(next!==null){stopWorkTimer(workInProgress);// If completing this work spawned new work, do that next. We'll come
// back here again.
...
next=completeUnitOfWork(workInProgress);}ReactCurrentOwner$1.current=null;return next;}function workLoop(isYieldy){if(!isYieldy){// Flush work without yielding
...
resetStack();nextRoot=root;nextRenderExpirationTime=expirationTime;nextUnitOfWork=createWorkInProgress(nextRoot.current,null);root.pendingCommitExpirationTime=NoWork;{// Determine which interactions this batch of work currently includes,
...
var retryCache=void 0;{retryCache=boundaryFiber.stateNode;}if(retryCache!==null){// The thenable resolved, so we no longer need to memoize, because it will
// never be thrown again.
...
var didYield=false;function shouldYieldToRenderer(){if(didYield){return true;}if(shouldYield()){didYield=true;return true;}return false;}function performAsyncWork(){try{if(!shouldYieldToRenderer()){// The callback timed out. That means at least one update has expired.
...
return null;}return findFiberByHostInstance(instance);}}));}var ReactFiberReconciler=Object.freeze({updateContainerAtExpirationTime:updateContainerAtExpirationTime,createContainer:createContainer,updateContainer:updateContainer,flushRoot:flushRoot,requestWork:requestWork,computeUniqueAsyncExpiration:computeUniqueAsyncExpiration,batchedUpdates:batchedUpdates,unbatchedUpdates:unbatchedUpdates,deferredUpdates:scheduler$1.unstable_next,syncUpdates:syncUpdates,interactiveUpdates:interactiveUpdates,flushInteractiveUpdates:flushInteractiveUpdates,flushControlled:flushControlled,flushSync:flushSync,getPublicRootInstance:getPublicRootInstance,findHostInstance:findHostInstance,findHostInstanceWithWarning:findHostInstanceWithWarning,findHostInstanceWithNoPortals:findHostInstanceWithNoPortals,injectIntoDevTools:injectIntoDevTools});// This entry point is intentionally not typed. It exists only for third-party
...
var reactReconciler=ReactFiberReconciler.default||ReactFiberReconciler;module.exports=reactReconciler;var $$$renderer=module.exports;module.exports=$$$reconciler;return $$$renderer;};}});var reactReconciler=createCommonjsModule(function(module){if(false){}else{module.exports=reactReconciler_development;}});class Root{constructor(_,props){const{documentRoot,selection}=props;this.instance=documentRoot;this.selection=selection;this.document=null;}appendChild(child){this.document=child;}removeChild(){this.document=null;}async render(){await this.document.render();}}const makeText=({text:textContent,color='#000000',fontSize=16})=>{const text=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Text"]();text.text=textContent;text.fill=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Color"](color);text.fontSize=fontSize;const{width,height}=text.localBounds;// text.areaBox = { width: width + 1, height };
return{text,width,height};};class Text{constructor(root,props){this.root=root;this.props=props;this.instance=null;this.width=0;this.height=0;if(typeof props.children==='string'){const text=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Text"]();text.text=props.children;text.fontSize=props.style.fontSize||16;const{width,height}=text.localBounds;this.width=width;this.height=height;console.log({width,height});}this.children=[];}appendChild(child){child.parent=this;this.children.push(child);}removeChild(child){const index=this.children.indexOf(child);if(index!==-1){child.parent=null;this.children.splice(index,1);}}// async renderChildren() {
//   for (const child of children) {
//     this.parent.instance.addNode(child);
//     await child.render();
//   }
// }
async render({layout}={layout:{left:0,top:0}}){const{name,style,children}=this.props;const{left,top}=layout;const{fontSize,color}=style||{};if(typeof children==='string'){const textContent=children;const{text,width,height}=makeText({text:textContent,color,fontSize});this.instance=text;this.parent.instance.addChild(text);text.moveInParentCoordinates(left,top+height);this.width=width;this.height=height;return;}// await this.renderChildren();
}}const computeLayout=__webpack_require__(/*! css-layout */ "../../node_modules/css-layout/dist/css-layout.js");class Document{constructor(root,props){this.root=root;this.props=props;this.children=[];}appendChild(child){child.parent=this;this.children.push(child);}removeChild(child){const index=this.children.indexOf(child);if(index!==-1){child.parent=null;this.children.splice(index,1);}}async renderArtboards(){const{children,props}=this;const nodeTree={style:props.style,children:children.map(child=>({style:child.props.style}))};computeLayout(nodeTree);let i=0;for(const child of children){await child.render({layout:nodeTree.children[i].layout});i+=1;}}async render(){await this.renderArtboards();}}var cssLayout=createCommonjsModule(function(module,exports){// UMD (Universal Module Definition)
...
var/*int*/childCount=node.children.length;var/*float*/paddingAndBorderAxisResolvedRow=getPaddingAndBorderAxis(node,resolvedRowAxis);if(isMeasureDefined(node)){var/*bool*/isResolvedRowDimDefined=!isUndefined(node.layout[dim[resolvedRowAxis]]);var/*float*/width=CSS_UNDEFINED;if(isDimDefined(node,resolvedRowAxis)){width=node.style.width;}else if(isResolvedRowDimDefined){width=node.layout[dim[resolvedRowAxis]];}else{width=parentMaxWidth-getMarginAxis(node,resolvedRowAxis);}width-=paddingAndBorderAxisResolvedRow;// We only need to give a dimension for the text if we haven't got any
// for it computed yet. It can either be from the style attribute or because
// the element is flexible.
var/*bool*/isRowUndefined=!isDimDefined(node,resolvedRowAxis)&&!isResolvedRowDimDefined;var/*bool*/isColumnUndefined=!isDimDefined(node,CSS_FLEX_DIRECTION_COLUMN)&&isUndefined(node.layout[dim[CSS_FLEX_DIRECTION_COLUMN]]);// Let's not measure the text if we already know both dimensions
if(isRowUndefined||isColumnUndefined){var/*css_dim_t*/measureDim=node.style.measure(/*(c)!node->context,*/ /*(java)!layoutContext.measureOutput,*/width);if(isRowUndefined){node.layout.width=measureDim.width+paddingAndBorderAxisResolvedRow;}if(isColumnUndefined){node.layout.height=measureDim.height+getPaddingAndBorderAxis(node,CSS_FLEX_DIRECTION_COLUMN);}}if(childCount===0){return;}}var/*bool*/isNodeFlexWrap=isFlexWrap(node);var/*css_justify_t*/justifyContent=getJustifyContent(node);var/*float*/leadingPaddingAndBorderMain=getLeadingPaddingAndBorder(node,mainAxis);var/*float*/leadingPaddingAndBorderCross=getLeadingPaddingAndBorder(node,crossAxis);var/*float*/paddingAndBorderAxisMain=getPaddingAndBorderAxis(node,mainAxis);var/*float*/paddingAndBorderAxisCross=getPaddingAndBorderAxis(node,crossAxis);var/*bool*/isMainDimDefined=!isUndefined(node.layout[dim[mainAxis]]);var/*bool*/isCrossDimDefined=!isUndefined(node.layout[dim[crossAxis]]);var/*bool*/isMainRowDirection=isRowDirection(mainAxis);var/*int*/i;var/*int*/ii;var/*css_node_t**/child;var/*(c)!css_flex_direction_t*/ /*(java)!int*/axis;var/*css_node_t**/firstAbsoluteChild=null;var/*css_node_t**/currentAbsoluteChild=null;var/*float*/definedMainDim=CSS_UNDEFINED;if(isMainDimDefined){definedMainDim=node.layout[dim[mainAxis]]-paddingAndBorderAxisMain;}// We want to execute the next two loops one per line with flex-wrap
var/*int*/startLine=0;var/*int*/endLine=0;// var/*int*/ nextOffset = 0;
var/*int*/alreadyComputedNextLayout=0;// We aggregate the total dimensions of the container in those two variables
var/*float*/linesCrossDim=0;var/*float*/linesMainDim=0;var/*int*/linesCount=0;while(endLine<childCount){// <Loop A> Layout non flexible children and count children by type
// mainContentDim is accumulation of the dimensions and margin of all the
// non flexible children. This will be used in order to either set the
// dimensions of the node if none already exist, or to compute the
// remaining space left for the flexible children.
var/*float*/mainContentDim=0;// There are three kind of children, non flexible, flexible and absolute.
// We need to know how many there are in order to distribute the space.
var/*int*/flexibleChildrenCount=0;var/*float*/totalFlexible=0;var/*int*/nonFlexibleChildrenCount=0;// Use the line loop to position children in the main axis for as long
// as they are using a simple stacking behaviour. Children that are
// immediately stacked in the initial loop will not be touched again
// in <Loop C>.
var/*bool*/isSimpleStackMain=isMainDimDefined&&justifyContent===CSS_JUSTIFY_FLEX_START||!isMainDimDefined&&justifyContent!==CSS_JUSTIFY_CENTER;var/*int*/firstComplexMain=isSimpleStackMain?childCount:startLine;// Use the initial line loop to position children in the cross axis for
// as long as they are relatively positioned with alignment STRETCH or
// FLEX_START. Children that are immediately stacked in the initial loop
// will not be touched again in <Loop D>.
var/*bool*/isSimpleStackCross=true;var/*int*/firstComplexCross=childCount;var/*css_node_t**/firstFlexChild=null;var/*css_node_t**/currentFlexChild=null;var/*float*/mainDim=leadingPaddingAndBorderMain;var/*float*/crossDim=0;var/*float*/maxWidth;for(i=startLine;i<childCount;++i){child=node.children[i];child.lineIndex=linesCount;child.nextAbsoluteChild=null;child.nextFlexChild=null;var/*css_align_t*/alignItem=getAlignItem(node,child);// Pre-fill cross axis dimensions when the child is using stretch before
// we call the recursive layout pass
if(alignItem===CSS_ALIGN_STRETCH&&getPositionType(child)===CSS_POSITION_RELATIVE&&isCrossDimDefined&&!isDimDefined(child,crossAxis)){child.layout[dim[crossAxis]]=fmaxf(boundAxis(child,crossAxis,node.layout[dim[crossAxis]]-paddingAndBorderAxisCross-getMarginAxis(child,crossAxis)),// You never want to go smaller than padding
getPaddingAndBorderAxis(child,crossAxis));}else if(getPositionType(child)===CSS_POSITION_ABSOLUTE){// Store a private linked list of absolutely positioned children
// so that we can efficiently traverse them later.
if(firstAbsoluteChild===null){firstAbsoluteChild=child;}if(currentAbsoluteChild!==null){currentAbsoluteChild.nextAbsoluteChild=child;}currentAbsoluteChild=child;// Pre-fill dimensions when using absolute position and both offsets for the axis are defined (either both
// left and right or top and bottom).
for(ii=0;ii<2;ii++){axis=ii!==0?CSS_FLEX_DIRECTION_ROW:CSS_FLEX_DIRECTION_COLUMN;if(!isUndefined(node.layout[dim[axis]])&&!isDimDefined(child,axis)&&isPosDefined(child,leading[axis])&&isPosDefined(child,trailing[axis])){child.layout[dim[axis]]=fmaxf(boundAxis(child,axis,node.layout[dim[axis]]-getPaddingAndBorderAxis(node,axis)-getMarginAxis(child,axis)-getPosition(child,leading[axis])-getPosition(child,trailing[axis])),// You never want to go smaller than padding
getPaddingAndBorderAxis(child,axis));}}}var/*float*/nextContentDim=0;// It only makes sense to consider a child flexible if we have a computed
// dimension for the node.
if(isMainDimDefined&&isFlex(child)){flexibleChildrenCount++;totalFlexible+=child.style.flex;// Store a private linked list of flexible children so that we can
// efficiently traverse them later.
if(firstFlexChild===null){firstFlexChild=child;}if(currentFlexChild!==null){currentFlexChild.nextFlexChild=child;}currentFlexChild=child;// Even if we don't know its exact size yet, we already know the padding,
// border and margin. We'll use this partial information, which represents
// the smallest possible size for the child, to compute the remaining
// available space.
nextContentDim=getPaddingAndBorderAxis(child,mainAxis)+getMarginAxis(child,mainAxis);}else{maxWidth=CSS_UNDEFINED;if(!isMainRowDirection){if(isDimDefined(node,resolvedRowAxis)){maxWidth=node.layout[dim[resolvedRowAxis]]-paddingAndBorderAxisResolvedRow;}else{maxWidth=parentMaxWidth-getMarginAxis(node,resolvedRowAxis)-paddingAndBorderAxisResolvedRow;}}// This is the main recursive call. We layout non flexible children.
if(alreadyComputedNextLayout===0){layoutNode(/*(java)!layoutContext, */child,maxWidth,direction);}// Absolute positioned elements do not take part of the layout, so we
// don't use them to compute mainContentDim
if(getPositionType(child)===CSS_POSITION_RELATIVE){nonFlexibleChildrenCount++;// At this point we know the final size and margin of the element.
nextContentDim=getDimWithMargin(child,mainAxis);}}// The element we are about to add would make us go to the next line
...
i!==startLine){nonFlexibleChildrenCount--;alreadyComputedNextLayout=1;break;}// Disable simple stacking in the main axis for the current line as
// we found a non-trivial child. The remaining children will be laid out
// in <Loop C>.
if(isSimpleStackMain&&(getPositionType(child)!==CSS_POSITION_RELATIVE||isFlex(child))){isSimpleStackMain=false;firstComplexMain=i;}// Disable simple stacking in the cross axis for the current line as
// we found a non-trivial child. The remaining children will be laid out
// in <Loop D>.
...
var/*float*/leadingMainDim=0;var/*float*/betweenMainDim=0;// The remaining available space that needs to be allocated
var/*float*/remainingMainDim=0;if(isMainDimDefined){remainingMainDim=definedMainDim-mainContentDim;}else{remainingMainDim=fmaxf(mainContentDim,0)-mainContentDim;}// If there are flexible children in the mix, they are going to fill the
// remaining space
if(flexibleChildrenCount!==0){var/*float*/flexibleMainDim=remainingMainDim/totalFlexible;var/*float*/baseMainDim;var/*float*/boundMainDim;// If the flex share of remaining space doesn't meet min/max bounds,
// remove this child from flex calculations.
currentFlexChild=firstFlexChild;while(currentFlexChild!==null){baseMainDim=flexibleMainDim*currentFlexChild.style.flex+getPaddingAndBorderAxis(currentFlexChild,mainAxis);boundMainDim=boundAxis(currentFlexChild,mainAxis,baseMainDim);if(baseMainDim!==boundMainDim){remainingMainDim-=boundMainDim;totalFlexible-=currentFlexChild.style.flex;}currentFlexChild=currentFlexChild.nextFlexChild;}flexibleMainDim=remainingMainDim/totalFlexible;// The non flexible children can overflow the container, in this case
// we should just assume that there is no space available.
if(flexibleMainDim<0){flexibleMainDim=0;}currentFlexChild=firstFlexChild;while(currentFlexChild!==null){// At this point we know the final size of the element in the main
// dimension
currentFlexChild.layout[dim[mainAxis]]=boundAxis(currentFlexChild,mainAxis,flexibleMainDim*currentFlexChild.style.flex+getPaddingAndBorderAxis(currentFlexChild,mainAxis));maxWidth=CSS_UNDEFINED;if(isDimDefined(node,resolvedRowAxis)){maxWidth=node.layout[dim[resolvedRowAxis]]-paddingAndBorderAxisResolvedRow;}else if(!isMainRowDirection){maxWidth=parentMaxWidth-getMarginAxis(node,resolvedRowAxis)-paddingAndBorderAxisResolvedRow;}// And we recursively call the layout algorithm for this child
layoutNode(/*(java)!layoutContext, */currentFlexChild,maxWidth,direction);child=currentFlexChild;currentFlexChild=currentFlexChild.nextFlexChild;child.nextFlexChild=null;}// We use justifyContent to figure out how to allocate the remaining
// space available
...
betweenMainDim=remainingMainDim/(flexibleChildrenCount+nonFlexibleChildrenCount);leadingMainDim=betweenMainDim/2;}}// <Loop C> Position elements in the main axis and compute dimensions
// At this point, all the children have their dimensions set. We need to
// find their position. In order to do that, we accumulate data in
// variables that are also useful to compute the total dimensions of the
// container!
mainDim+=leadingMainDim;for(i=firstComplexMain;i<endLine;++i){child=node.children[i];if(getPositionType(child)===CSS_POSITION_ABSOLUTE&&isPosDefined(child,leading[mainAxis])){// In case the child is position absolute and has left/top being
// defined, we override the position to whatever the user said
// (and margin/border).
child.layout[pos[mainAxis]]=getPosition(child,leading[mainAxis])+getLeadingBorder(node,mainAxis)+getLeadingMargin(child,mainAxis);}else{// If the child is position absolute (without top/left) or relative,
// we put it at the current accumulated offset.
child.layout[pos[mainAxis]]+=mainDim;// Define the trailing position accordingly.
if(isMainDimDefined){setTrailingPosition(node,child,mainAxis);}// Now that we placed the element, we need to update the variables
// We only need to do that for relative elements. Absolute elements
// do not take part in that phase.
if(getPositionType(child)===CSS_POSITION_RELATIVE){// The main dimension is the sum of all the elements dimension plus
// the spacing.
...
crossDim=fmaxf(crossDim,boundAxis(child,crossAxis,getDimWithMargin(child,crossAxis)));}}}var/*float*/containerCrossAxis=node.layout[dim[crossAxis]];if(!isCrossDimDefined){containerCrossAxis=fmaxf(// For the cross dim, we add both sides at the end because the value
// is aggregate via a max function. Intermediate negative values
// can mess this computation otherwise
boundAxis(node,crossAxis,crossDim+paddingAndBorderAxisCross),paddingAndBorderAxisCross);}// <Loop D> Position elements in the cross axis
for(i=firstComplexCross;i<endLine;++i){child=node.children[i];if(getPositionType(child)===CSS_POSITION_ABSOLUTE&&isPosDefined(child,leading[crossAxis])){// In case the child is absolutely positionned and has a
// top/left/bottom/right being set, we override all the previously
// computed positions to set it correctly.
child.layout[pos[crossAxis]]=getPosition(child,leading[crossAxis])+getLeadingBorder(node,crossAxis)+getLeadingMargin(child,crossAxis);}else{var/*float*/leadingCrossDim=leadingPaddingAndBorderCross;// For a relative children, we're either using alignItems (parent) or
// alignSelf (child) in order to determine the position in the cross axis
if(getPositionType(child)===CSS_POSITION_RELATIVE){/*eslint-disable */ // This variable is intentionally re-defined as the code is transpiled to a block scope language
var/*css_align_t*/alignItem=getAlignItem(node,child);/*eslint-enable */if(alignItem===CSS_ALIGN_STRETCH){// You can only stretch if the dimension has not already been set
// previously.
if(isUndefined(child.layout[dim[crossAxis]])){child.layout[dim[crossAxis]]=fmaxf(boundAxis(child,crossAxis,containerCrossAxis-paddingAndBorderAxisCross-getMarginAxis(child,crossAxis)),// You never want to go smaller than padding
getPaddingAndBorderAxis(child,crossAxis));}}else if(alignItem!==CSS_ALIGN_FLEX_START){// The remaining space between the parent dimensions+padding and child
// dimensions+margin.
var/*float*/remainingCrossDim=containerCrossAxis-paddingAndBorderAxisCross-getDimWithMargin(child,crossAxis);if(alignItem===CSS_ALIGN_CENTER){leadingCrossDim+=remainingCrossDim/2;}else{// CSS_ALIGN_FLEX_END
leadingCrossDim+=remainingCrossDim;}}}// And we apply the position
child.layout[pos[crossAxis]]+=linesCrossDim+leadingCrossDim;// Define the trailing position accordingly.
if(isCrossDimDefined){setTrailingPosition(node,child,crossAxis);}}}linesCrossDim+=crossDim;linesMainDim=fmaxf(linesMainDim,mainDim);linesCount+=1;startLine=endLine;}// <Loop E>
//
...
// section 9.4
//
if(linesCount>1&&isCrossDimDefined){var/*float*/nodeCrossAxisInnerSize=node.layout[dim[crossAxis]]-paddingAndBorderAxisCross;var/*float*/remainingAlignContentDim=nodeCrossAxisInnerSize-linesCrossDim;var/*float*/crossDimLead=0;var/*float*/currentLead=leadingPaddingAndBorderCross;var/*css_align_t*/alignContent=getAlignContent(node);if(alignContent===CSS_ALIGN_FLEX_END){currentLead+=remainingAlignContentDim;}else if(alignContent===CSS_ALIGN_CENTER){currentLead+=remainingAlignContentDim/2;}else if(alignContent===CSS_ALIGN_STRETCH){if(nodeCrossAxisInnerSize>linesCrossDim){crossDimLead=remainingAlignContentDim/linesCount;}}var/*int*/endIndex=0;for(i=0;i<linesCount;++i){var/*int*/startIndex=endIndex;// compute the line's height and find the endIndex
var/*float*/lineHeight=0;for(ii=startIndex;ii<childCount;++ii){child=node.children[ii];if(getPositionType(child)!==CSS_POSITION_RELATIVE){continue;}if(child.lineIndex!==i){break;}if(!isUndefined(child.layout[dim[crossAxis]])){lineHeight=fmaxf(lineHeight,child.layout[dim[crossAxis]]+getMarginAxis(child,crossAxis));}}endIndex=ii;lineHeight+=crossDimLead;for(ii=startIndex;ii<endIndex;++ii){child=node.children[ii];if(getPositionType(child)!==CSS_POSITION_RELATIVE){continue;}var/*css_align_t*/alignContentAlignItem=getAlignItem(node,child);if(alignContentAlignItem===CSS_ALIGN_FLEX_START){child.layout[pos[crossAxis]]=currentLead+getLeadingMargin(child,crossAxis);}else if(alignContentAlignItem===CSS_ALIGN_FLEX_END){child.layout[pos[crossAxis]]=currentLead+lineHeight-getTrailingMargin(child,crossAxis)-child.layout[dim[crossAxis]];}else if(alignContentAlignItem===CSS_ALIGN_CENTER){var/*float*/childHeight=child.layout[dim[crossAxis]];child.layout[pos[crossAxis]]=currentLead+(lineHeight-childHeight)/2;}else if(alignContentAlignItem===CSS_ALIGN_STRETCH){child.layout[pos[crossAxis]]=currentLead+getLeadingMargin(child,crossAxis);// TODO(prenaux): Correctly set the height of items with undefined
//                (auto) crossAxis dimension.
}}currentLead+=lineHeight;}}var/*bool*/needsMainTrailingPos=false;var/*bool*/needsCrossTrailingPos=false;// If the user didn't specify a width or height, and it has not been set
// by the container, then we set it via the children.
if(!isMainDimDefined){node.layout[dim[mainAxis]]=fmaxf(// We're missing the last padding at this point to get the final
// dimension
...
paddingAndBorderAxisMain);if(mainAxis===CSS_FLEX_DIRECTION_ROW_REVERSE||mainAxis===CSS_FLEX_DIRECTION_COLUMN_REVERSE){needsMainTrailingPos=true;}}if(!isCrossDimDefined){node.layout[dim[crossAxis]]=fmaxf(// For the cross dim, we add both sides at the end because the value
// is aggregate via a max function. Intermediate negative values
// can mess this computation otherwise
boundAxis(node,crossAxis,linesCrossDim+paddingAndBorderAxisCross),paddingAndBorderAxisCross);if(crossAxis===CSS_FLEX_DIRECTION_ROW_REVERSE||crossAxis===CSS_FLEX_DIRECTION_COLUMN_REVERSE){needsCrossTrailingPos=true;}}// <Loop F> Set trailing position if necessary
if(needsMainTrailingPos||needsCrossTrailingPos){for(i=0;i<childCount;++i){child=node.children[i];if(needsMainTrailingPos){setTrailingPosition(node,child,mainAxis);}if(needsCrossTrailingPos){setTrailingPosition(node,child,crossAxis);}}}// <Loop G> Calculate dimensions for absolutely positioned elements
currentAbsoluteChild=firstAbsoluteChild;while(currentAbsoluteChild!==null){// Pre-fill dimensions when using absolute position and both offsets for
...
getPaddingAndBorderAxis(currentAbsoluteChild,axis));}if(isPosDefined(currentAbsoluteChild,trailing[axis])&&!isPosDefined(currentAbsoluteChild,leading[axis])){currentAbsoluteChild.layout[leading[axis]]=node.layout[dim[axis]]-currentAbsoluteChild.layout[dim[axis]]-getPosition(currentAbsoluteChild,trailing[axis]);}}child=currentAbsoluteChild;currentAbsoluteChild=currentAbsoluteChild.nextAbsoluteChild;child.nextAbsoluteChild=null;}}function layoutNode(node,parentMaxWidth,parentDirection){node.shouldUpdate=true;var direction=node.style.direction||CSS_DIRECTION_LTR;var skipLayout=!node.isDirty&&node.lastLayout&&node.lastLayout.requestedHeight===node.layout.height&&node.lastLayout.requestedWidth===node.layout.width&&node.lastLayout.parentMaxWidth===parentMaxWidth&&node.lastLayout.direction===direction;if(skipLayout){node.layout.width=node.lastLayout.width;node.layout.height=node.lastLayout.height;node.layout.top=node.lastLayout.top;node.layout.left=node.lastLayout.left;}else{if(!node.lastLayout){node.lastLayout={};}node.lastLayout.requestedWidth=node.layout.width;node.lastLayout.requestedHeight=node.layout.height;node.lastLayout.parentMaxWidth=parentMaxWidth;node.lastLayout.direction=direction;// Reset child layouts
node.children.forEach(function(child){child.layout.width=undefined;child.layout.height=undefined;child.layout.top=0;child.layout.left=0;});layoutNodeImpl(node,parentMaxWidth,parentDirection);node.lastLayout.width=node.layout.width;node.lastLayout.height=node.layout.height;node.lastLayout.top=node.layout.top;node.lastLayout.left=node.layout.left;}}return{layoutNodeImpl:layoutNodeImpl,computeLayout:layoutNode,fillNodes:fillNodes};}();// This module export is only used for the purposes of unit testing this file. When
// the library is packaged this file is included within css-layout.js which forms
// the public API.
{module.exports=computeLayout;}return function(node){/*eslint-disable */ // disabling ESLint because this code relies on the above include
computeLayout.fillNodes(node);computeLayout.computeLayout(node);/*eslint-enable */};});});const makeArtboard=({name='Artboard',color='#FFFFFF',width=360,height=640})=>{const artboard=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Artboard"]();artboard.fill=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Color"](color);artboard.fillEnabled=true;artboard.height=height;artboard.width=width;if(name){artboard.name=name;}return artboard;};class Artboard{constructor(root,props){this.root=root;this.props=props;this.instance=null;this.children=[];}appendChild(child){child.parent=this;this.children.push(child);}removeChild(child){const index=this.children.indexOf(child);if(index!==-1){child.parent=null;this.children.splice(index,1);}}async renderChildren(){const{children,props}=this;const nodeTree={style:props.style,children:children.map(child=>({style:{...(child.width?{width:child.width}:{}),...(child.height?{height:child.height}:{}),...child.props.style}}))};cssLayout(nodeTree);let i=0;for(const child of children){await child.render({layout:nodeTree.children[i].layout});i+=1;}}async render({layout}){const{name,style}=this.props;const{left,top}=layout;const{width,height,backgroundColor}=style;const artboard=makeArtboard({name,color:backgroundColor,height,width});this.instance=artboard;this.root.instance.addChild(artboard);artboard.moveInParentCoordinates(left,top);await this.renderChildren();}}const makeRectangle=({name='ShapeGroup',color,width=360,height=640,borderRadius})=>{const rectangle=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Rectangle"]();if(color){rectangle.fill=new scenegraph__WEBPACK_IMPORTED_MODULE_1__["Color"](color);rectangle.fillEnabled=true;}if(borderRadius){rectangle.setAllCornerRadii(borderRadius);}rectangle.height=height;rectangle.width=width;if(name){rectangle.name=name;}return rectangle;};class View{constructor(root,props){this.root=root;this.props=props;this.instance=null;this.children=[];}appendChild(child){child.parent=this;this.children.push(child);}removeChild(child){const index=this.children.indexOf(child);if(index!==-1){child.parent=null;this.children.splice(index,1);}}async renderChildren(){const{children,props}=this;const nodeTree={style:props.style,children:children.map(child=>({style:{...(child.width?{width:child.width}:{}),...(child.height?{height:child.height}:{}),...child.props.style}}))};cssLayout(nodeTree);let i=0;for(const child of children){await child.render({layout:nodeTree.children[i].layout});i+=1;}}async render({layout}={layout:{left:0,top:0}}){const{name,style}=this.props;const{left,top}=layout;const{width,height,backgroundColor,borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius}=style;// FIXME: borderRadius hack for initial proof of concept. Needs to be fixed up in a DRY manner
// Idea was to use borderRadius, but we're flattening styles
const rectangle=makeRectangle({color:backgroundColor,height,width,borderRadius:borderBottomLeftRadius});this.parent.instance.addChild(rectangle);this.root.selection.items=[rectangle];commands__WEBPACK_IMPORTED_MODULE_2___default.a.group();const group=this.root.selection.items[0];group.name=name;this.instance=group;group.moveInParentCoordinates(left,top);await this.renderChildren();}}const constructors={root:Root,document:Document,artboard:Artboard,text:Text,view:View};function createInstance(element,root){const{type,props={}}=element;if(constructors[type]){return new constructors[type](root,props);}throw new Error(`Invalid element of type ${type} passed to XD renderer`);}function traceWrap(hostConfig){let traceWrappedHostConfig={};Object.keys(hostConfig).map(key=>{const func=hostConfig[key];traceWrappedHostConfig[key]=(...args)=>{console.trace(key);return func(...args);};});return traceWrappedHostConfig;}const rootHostContext={};const hostConfig={now:Date.now,getRootHostContext:()=>{return rootHostContext;},prepareForCommit:()=>{},resetAfterCommit:()=>{},getChildHostContext:(parentContext,fiberType,rootInstance)=>{let context={type:fiberType};return context;},shouldSetTextContent:(type,props)=>{return typeof props.children==='string'||typeof props.children==='number';},createInstance:(type,props,rootContainerInstance,_currentHostContext,workInProgress)=>{return createInstance({type,props},rootContainerInstance);},createTextInstance:(text,rootContainerInstance,hostContext,internalInstanceHandle)=>{return createInstance({type:'text',props:{children:text}},rootContainerInstance);// return document.createTextNode(text);
},appendInitialChild:(parent,child)=>{parent.appendChild(child);},appendChild(parent,child){parent.appendChild(child);},finalizeInitialChildren:(domElement,type,props)=>{},supportsMutation:true,appendChildToContainer:(parent,child)=>{parent.appendChild(child);},prepareUpdate(domElement,oldProps,newProps){return true;},commitUpdate(domElement,updatePayload,type,oldProps,newProps){},commitTextUpdate(textInstance,oldText,newText){},removeChild(parentInstance,child){}};const ReactReconcilerInst=reactReconciler(traceWrap(hostConfig));const render=async(reactElement,{documentRoot,selection},callback)=>{const rootContainer=createInstance({type:'root',props:{documentRoot,selection}});const mountNode=ReactReconcilerInst.createContainer(rootContainer);// update the root Container
ReactReconcilerInst.updateContainer(reactElement,mountNode,null,callback);await rootContainer.render();};function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}var reactIs_production_min=createCommonjsModule(function(module,exports){Object.defineProperty(exports,"__esModule",{value:!0});var b="function"===typeof Symbol&&Symbol.for,c=b?Symbol.for("react.element"):60103,d=b?Symbol.for("react.portal"):60106,e=b?Symbol.for("react.fragment"):60107,f=b?Symbol.for("react.strict_mode"):60108,g=b?Symbol.for("react.profiler"):60114,h=b?Symbol.for("react.provider"):60109,k=b?Symbol.for("react.context"):60110,l=b?Symbol.for("react.async_mode"):60111,m=b?Symbol.for("react.concurrent_mode"):60111,n=b?Symbol.for("react.forward_ref"):60112,p=b?Symbol.for("react.suspense"):60113,q=b?Symbol.for("react.memo"):60115,r=b?Symbol.for("react.lazy"):60116;function t(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m:case e:case g:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case h:return a;default:return u;}}case r:case q:case d:return u;}}}function v(a){return t(a)===m;}exports.typeOf=t;exports.AsyncMode=l;exports.ConcurrentMode=m;exports.ContextConsumer=k;exports.ContextProvider=h;exports.Element=c;exports.ForwardRef=n;exports.Fragment=e;exports.Lazy=r;exports.Memo=q;exports.Portal=d;exports.Profiler=g;exports.StrictMode=f;exports.Suspense=p;exports.isValidElementType=function(a){return"string"===typeof a||"function"===typeof a||a===e||a===m||a===g||a===f||a===p||"object"===typeof a&&null!==a&&(a.$$typeof===r||a.$$typeof===q||a.$$typeof===h||a.$$typeof===k||a.$$typeof===n);};exports.isAsyncMode=function(a){return v(a)||t(a)===l;};exports.isConcurrentMode=v;exports.isContextConsumer=function(a){return t(a)===k;};exports.isContextProvider=function(a){return t(a)===h;};exports.isElement=function(a){return"object"===typeof a&&null!==a&&a.$$typeof===c;};exports.isForwardRef=function(a){return t(a)===n;};exports.isFragment=function(a){return t(a)===e;};exports.isLazy=function(a){return t(a)===r;};exports.isMemo=function(a){return t(a)===q;};exports.isPortal=function(a){return t(a)===d;};exports.isProfiler=function(a){return t(a)===g;};exports.isStrictMode=function(a){return t(a)===f;};exports.isSuspense=function(a){return t(a)===p;};});unwrapExports(reactIs_production_min);var reactIs_production_min_1=reactIs_production_min.typeOf;var reactIs_production_min_2=reactIs_production_min.AsyncMode;var reactIs_production_min_3=reactIs_production_min.ConcurrentMode;var reactIs_production_min_4=reactIs_production_min.ContextConsumer;var reactIs_production_min_5=reactIs_production_min.ContextProvider;var reactIs_production_min_6=reactIs_production_min.Element;var reactIs_production_min_7=reactIs_production_min.ForwardRef;var reactIs_production_min_8=reactIs_production_min.Fragment;var reactIs_production_min_9=reactIs_production_min.Lazy;var reactIs_production_min_10=reactIs_production_min.Memo;var reactIs_production_min_11=reactIs_production_min.Portal;var reactIs_production_min_12=reactIs_production_min.Profiler;var reactIs_production_min_13=reactIs_production_min.StrictMode;var reactIs_production_min_14=reactIs_production_min.Suspense;var reactIs_production_min_15=reactIs_production_min.isValidElementType;var reactIs_production_min_16=reactIs_production_min.isAsyncMode;var reactIs_production_min_17=reactIs_production_min.isConcurrentMode;var reactIs_production_min_18=reactIs_production_min.isContextConsumer;var reactIs_production_min_19=reactIs_production_min.isContextProvider;var reactIs_production_min_20=reactIs_production_min.isElement;var reactIs_production_min_21=reactIs_production_min.isForwardRef;var reactIs_production_min_22=reactIs_production_min.isFragment;var reactIs_production_min_23=reactIs_production_min.isLazy;var reactIs_production_min_24=reactIs_production_min.isMemo;var reactIs_production_min_25=reactIs_production_min.isPortal;var reactIs_production_min_26=reactIs_production_min.isProfiler;var reactIs_production_min_27=reactIs_production_min.isStrictMode;var reactIs_production_min_28=reactIs_production_min.isSuspense;var reactIs_development=createCommonjsModule(function(module,exports){if(true){(function(){Object.defineProperty(exports,'__esModule',{value:true});// The Symbol used to tag the ReactElement-like types. If there is no native Symbol
// nor polyfill, then a plain number is used for performance.
...
var throwOnDirectAccess=true;module.exports=factoryWithTypeCheckers(ReactIs.isElement,throwOnDirectAccess);}else{}});class Document$1 extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{render(){const{style,children}=this.props;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("document",{style:{flexDirection:'row',...style}},children);}}_defineProperty(Document$1,"propTypes",{children:propTypes.node});/* eslint max-len:0 no-nested-ternary:0 */const{hasOwnProperty:hasOwnProperty$1}=Object.prototype;const styleShortHands={borderColor:{borderTopColor:true,borderRightColor:true,borderBottomColor:true,borderLeftColor:true},borderRadius:{borderTopLeftRadius:true,borderTopRightRadius:true,borderBottomRightRadius:true,borderBottomLeftRadius:true},borderStyle:{borderTopStyle:true,borderRightStyle:true,borderBottomStyle:true,borderLeftStyle:true},borderWidth:{borderTopWidth:true,borderRightWidth:true,borderBottomWidth:true,borderLeftWidth:true},margin:{marginTop:true,marginRight:true,marginBottom:true,marginLeft:true},marginHorizontal:{marginRight:true,marginLeft:true},marginVertical:{marginTop:true,marginBottom:true},overflow:{overflowX:true,overflowY:true},padding:{paddingTop:true,paddingRight:true,paddingBottom:true,paddingLeft:true},paddingHorizontal:{paddingRight:true,paddingLeft:true},paddingVertical:{paddingTop:true,paddingBottom:true},textDecorationLine:{textDecoration:true},writingDirection:{direction:true}};/**
 ...
 * originally declared.
 */const sortProps=propsArray=>propsArray.sort((a,b)=>{const expandedA=styleShortHands[a];const expandedB=styleShortHands[b];if(expandedA&&expandedA[b]){return-1;}if(expandedB&&expandedB[a]){return 1;}return a<b?-1:a>b?1:0;});/**
 * Expand the shorthand properties to isolate every declaration from the others.
 */var expandStyle=style=>{if(!style)return style;/* eslint no-param-reassign:0 */const propsArray=Object.keys(style);const sortedProps=sortProps(propsArray);const resolvedStyle={};// eslint-disable-next-line no-plusplus
for(let i=0;i<sortedProps.length;i++){const key=sortedProps[i];const expandedProps=styleShortHands[key];const value=style[key];if(expandedProps){// eslint-disable-next-line no-restricted-syntax
for(const propName in expandedProps){if(hasOwnProperty$1.call(expandedProps,propName)){resolvedStyle[propName]=value;}}}else{resolvedStyle[key]=value;}}return resolvedStyle;};const{hasOwnProperty:hasOwnProperty$2}=Object.prototype;let _id=0;// eslint-disable-next-line no-plusplus
const guid=()=>_id++;const declarationRegistry={};const extractRules=style=>{const declarations={};Object.keys(style).forEach(key=>{if(key[0]===':');else if(key[0]==='@');else{declarations[key]=style[key];}});return{declarations};};const registerStyle=style=>{// TODO(lmr):
// do "proptype"-like validation here in non-production build
const id=guid();const rules=extractRules(style);declarationRegistry[id]=expandStyle(rules.declarations);return id;};const getStyle=id=>declarationRegistry[id];const create=styles=>{const result={};Object.keys(styles).forEach(key=>{result[key]=registerStyle(styles[key]);});return result;};const mergeTransforms=(a,b)=>{if(!a||a.length===0)return b;// in this case, a has nothing to contribute.
const result=[];const transformsInA=a.reduce((hash,t)=>{const key=Object.keys(t)[0];result.push(t);hash[key]=result.length-1;return hash;},{});b.forEach(t=>{const key=Object.keys(t)[0];const index=transformsInA[key];if(index!==undefined){result[index]=t;}else{result.push(t);}});return result;};// merge two style hashes together. Sort of like `Object.assign`, but is aware of `transform` as a
// special case.
// NOTE(lmr): mutates the first argument!
const mergeStyle=(a,b)=>{let key;// eslint-disable-next-line no-restricted-syntax
for(key in b){if(hasOwnProperty$2.call(b,key)){switch(key){case'transform':a[key]=mergeTransforms(a[key],b[key]);break;default:/* eslint no-param-reassign: 0 */a[key]=b[key];break;}}}return a;};const flattenStyle=input=>{if(Array.isArray(input)){return input.reduce((acc,val)=>mergeStyle(acc,flattenStyle(val)||{}),{});}if(typeof input==='number'){return getStyle(input);}if(!input){// input is falsy, so we skip it by returning undefined
return undefined;}return expandStyle(input);};/**
 * A StyleSheet is an abstraction similar to CSS StyleSheets. WIP.
 */var StyleSheet={hairlineWidth:1,// TODO(lmr): should this be something different?
absoluteFill:registerStyle({position:'absolute',top:0,left:0,bottom:0,right:0}),create,flatten:flattenStyle,resolve:style=>({style:flattenStyle(style)})};class Artboard$1 extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{render(){const{name,style,children}=this.props;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("artboard",{name:name,style:{width:360,height:640,...style}},children);}}_defineProperty(Artboard$1,"defaultProps",{name:'Artboard'});class Text$1 extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{render(){const{name,style,children}=this.props;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("text",{name:name,style:{fontSize:16,...(style&&StyleSheet.flatten(style))}},children);}}_defineProperty(Text$1,"defaultProps",{name:'Text'});class View$1 extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component{render(){const{name,style,children}=this.props;return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("view",{name:name,style:{flexDirection:'column',...(style&&StyleSheet.flatten(style))}},children);}}_defineProperty(View$1,"defaultProps",{name:'View'});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../examples/colors/node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "../../node_modules/css-layout/dist/css-layout.js":
/*!************************************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/css-layout/dist/css-layout.js ***!
  \************************************************************************************************************/
...
/*!*****************************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/object-assign/index.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!***********************************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/prop-types/checkPropTypes.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*********************************************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/prop-types/lib/ReactPropTypesSecret.js ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*************************************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/react/cjs/react.development.js ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*********************************************************************************************!*\
  !*** /Users/macintoshhelper/Documents/Projects/github/react-xd/node_modules/react/index.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_xd__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-xd */ "../../dist/bundle.esm.js");
// [1]
...
const Swatch = ({
  name,
  hex
}) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["View"], {
  style: {
    margin: 24,
    borderRadius: 4,
    height: 250,
  ...
  name: "Swatch"
}, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Text"], {
  style: {
    color: 'white',
    fontSize: 120
  }
...
const App = ({
  colors
}) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Document"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Artboard"], {
  style: {
    height: 2048,
    width: 1024,
    padding: 24,
  ...
  name: "Swatches"
}, Object.keys(colors).map(color => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Swatch, {
  key: color,
  name: color,
  hex: colors[color]
}))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Artboard"], {
  name: "Mobile",
  style: {
    marginLeft: 70,
...
}, "Hello World 3"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Text"], null, "Hello World 4"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["View"], {
  style: {
    width: 360,
    height: 100,
...
}, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_xd__WEBPACK_IMPORTED_MODULE_1__["Text"], null, "Centered Text"))));
...
function renderToXd(selection, documentRoot) {
  ...
  return Object(react_xd__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(App, {
    colors: colorList
  }), {
    selection,
    documentRoot
